...
loadjs.ready("head", function () {
    ...
    fPASIEN_VISITATIONsearch.addFields([
        ...
        ["IN_DATE", [ew.Validators.datetime(11)], fields.IN_DATE.isInvalid],
    ...
    fPASIEN_VISITATIONsearch.lists.RUJUKAN_ID = <?= $Page->RUJUKAN_ID->toClientList($Page) ?>;
    ...
    fPASIEN_VISITATIONsearch.lists.PATIENT_CATEGORY_ID = <?= $Page->PATIENT_CATEGORY_ID->toClientList($Page) ?>;
    fPASIEN_VISITATIONsearch.lists.ISNEW = <?= $Page->ISNEW->toClientList($Page) ?>;
    fPASIEN_VISITATIONsearch.lists.CLINIC_ID_FROM = <?= $Page->CLINIC_ID_FROM->toClientList($Page) ?>;
    ...
    fPASIEN_VISITATIONsearch.lists.RESPONSIBLE_ID = <?= $Page->RESPONSIBLE_ID->toClientList($Page) ?>;
    fPASIEN_VISITATIONsearch.lists.PAYOR_ID = <?= $Page->PAYOR_ID->toClientList($Page) ?>;
    ...
    fPASIEN_VISITATIONsearch.lists.ISRJ = <?= $Page->ISRJ->toClientList($Page) ?>;
...
<?php if ($Page->RUJUKAN_ID->Visible) { // RUJUKAN_ID ?>
    <div id="r_RUJUKAN_ID" class="form-group row">
        <label for="x_RUJUKAN_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_RUJUKAN_ID"><?= $Page->RUJUKAN_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->PATIENT_CATEGORY_ID->Visible) { // PATIENT_CATEGORY_ID ?>
    <div id="r_PATIENT_CATEGORY_ID" class="form-group row">
        <label for="x_PATIENT_CATEGORY_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_PATIENT_CATEGORY_ID"><?= $Page->PATIENT_CATEGORY_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_PATIENT_CATEGORY_ID" id="z_PATIENT_CATEGORY_ID" value="=">
    ...
    <select
        ...
        data-select2-id="PASIEN_VISITATION_x_PATIENT_CATEGORY_ID"
        data-table="PASIEN_VISITATION"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_VISITATION_x_PATIENT_CATEGORY_ID']"),
        options = { name: "x_PATIENT_CATEGORY_ID", selectId: "PASIEN_VISITATION_x_PATIENT_CATEGORY_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN_VISITATION.fields.PATIENT_CATEGORY_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->FOLLOW_UP->Visible) { // FOLLOW_UP ?>
    <div id="r_FOLLOW_UP" class="form-group row">
        <label for="x_FOLLOW_UP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_FOLLOW_UP"><?= $Page->FOLLOW_UP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->PLACE_TYPE->Visible) { // PLACE_TYPE ?>
    <div id="r_PLACE_TYPE" class="form-group row">
        <label for="x_PLACE_TYPE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_PLACE_TYPE"><?= $Page->PLACE_TYPE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->CLINIC_ID_FROM->Visible) { // CLINIC_ID_FROM ?>
    <div id="r_CLINIC_ID_FROM" class="form-group row">
        <label for="x_CLINIC_ID_FROM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_CLINIC_ID_FROM"><?= $Page->CLINIC_ID_FROM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CLINIC_ID_FROM" id="z_CLINIC_ID_FROM" value="LIKE">
    ...
    <select
        ...
        data-select2-id="PASIEN_VISITATION_x_CLINIC_ID_FROM"
        data-table="PASIEN_VISITATION"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_VISITATION_x_CLINIC_ID_FROM']"),
        options = { name: "x_CLINIC_ID_FROM", selectId: "PASIEN_VISITATION_x_CLINIC_ID_FROM", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN_VISITATION.fields.CLINIC_ID_FROM.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->IN_DATE->Visible) { // IN_DATE ?>
    <div id="r_IN_DATE" class="form-group row">
        <label for="x_IN_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_IN_DATE"><?= $Page->IN_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<input type="<?= $Page->DESCRIPTION->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_DESCRIPTION" name="x_DESCRIPTION" id="x_DESCRIPTION" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->DESCRIPTION->getPlaceHolder()) ?>" value="<?= $Page->DESCRIPTION->EditValue ?>"<?= $Page->DESCRIPTION->editAttributes() ?>>
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <div id="r_MODIFIED_BY" class="form-group row">
        <label for="x_MODIFIED_BY" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_MODIFIED_BY"><?= $Page->MODIFIED_BY->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->MODIFIED_DATE->Visible) { // MODIFIED_DATE ?>
    <div id="r_MODIFIED_DATE" class="form-group row">
        <label for="x_MODIFIED_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_MODIFIED_DATE"><?= $Page->MODIFIED_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->MODIFIED_FROM->Visible) { // MODIFIED_FROM ?>
    <div id="r_MODIFIED_FROM" class="form-group row">
        <label for="x_MODIFIED_FROM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_MODIFIED_FROM"><?= $Page->MODIFIED_FROM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->RESPONSIBLE_ID->Visible) { // RESPONSIBLE_ID ?>
    <div id="r_RESPONSIBLE_ID" class="form-group row">
        <label for="x_RESPONSIBLE_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_RESPONSIBLE_ID"><?= $Page->RESPONSIBLE_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RESPONSIBLE_ID" id="z_RESPONSIBLE_ID" value="=">
    ...
    <select
        ...
        class="form-control ew-select<?= $Page->RESPONSIBLE_ID->isInvalidClass() ?>"
        data-select2-id="PASIEN_VISITATION_x_RESPONSIBLE_ID"
        data-table="PASIEN_VISITATION"
        data-field="x_RESPONSIBLE_ID"
        data-value-separator="<?= $Page->RESPONSIBLE_ID->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->RESPONSIBLE_ID->getPlaceHolder()) ?>"
        <?= $Page->RESPONSIBLE_ID->editAttributes() ?>>
        <?= $Page->RESPONSIBLE_ID->selectOptionListHtml("x_RESPONSIBLE_ID") ?>
    </select>
    <div class="invalid-feedback"><?= $Page->RESPONSIBLE_ID->getErrorMessage(false) ?></div>
<?= $Page->RESPONSIBLE_ID->Lookup->getParamTag($Page, "p_x_RESPONSIBLE_ID") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_VISITATION_x_RESPONSIBLE_ID']"),
        options = { name: "x_RESPONSIBLE_ID", selectId: "PASIEN_VISITATION_x_RESPONSIBLE_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN_VISITATION.fields.RESPONSIBLE_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->ISATTENDED->Visible) { // ISATTENDED ?>
    <div id="r_ISATTENDED" class="form-group row">
        <label for="x_ISATTENDED" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_ISATTENDED"><?= $Page->ISATTENDED->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->ISATTENDED->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_ISATTENDED" name="x_ISATTENDED" id="x_ISATTENDED" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISATTENDED->getPlaceHolder()) ?>" value="<?= $Page->ISATTENDED->EditValue ?>"<?= $Page->ISATTENDED->editAttributes() ?>>
...
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <div id="r_PAYOR_ID" class="form-group row">
        <label for="x_PAYOR_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_PAYOR_ID"><?= $Page->PAYOR_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <div id="r_CLASS_ID" class="form-group row">
        <label for="x_CLASS_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_CLASS_ID"><?= $Page->CLASS_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->ISPERTARIF->Visible) { // ISPERTARIF ?>
    <div id="r_ISPERTARIF" class="form-group row">
        <label for="x_ISPERTARIF" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_ISPERTARIF"><?= $Page->ISPERTARIF->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->CLASS_ID_PLAFOND->Visible) { // CLASS_ID_PLAFOND ?>
    <div id="r_CLASS_ID_PLAFOND" class="form-group row">
        <label for="x_CLASS_ID_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_CLASS_ID_PLAFOND"><?= $Page->CLASS_ID_PLAFOND->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
...
<?php if ($Page->BACKCHARGE->Visible) { // BACKCHARGE ?>
    <div id="r_BACKCHARGE" class="form-group row">
        <label for="x_BACKCHARGE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_BACKCHARGE"><?= $Page->BACKCHARGE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="hidden"
    ...
    id="x_COVERAGE_ID"
    name="x_COVERAGE_ID"
    value="<?= HtmlEncode($Page->COVERAGE_ID->AdvancedSearch->SearchValue) ?>"
    data-type="select-one"
...
<?php if ($Page->LOCKED->Visible) { // LOCKED ?>
    <div id="r_LOCKED" class="form-group row">
        <label for="x_LOCKED" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_LOCKED"><?= $Page->LOCKED->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->DIAGNOSA_ID->Visible) { // DIAGNOSA_ID ?>
    <div id="r_DIAGNOSA_ID" class="form-group row">
        <label for="x_DIAGNOSA_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_DIAGNOSA_ID"><?= $Page->DIAGNOSA_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->tanggal_rujukan->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_tanggal_rujukan" name="x_tanggal_rujukan" id="x_tanggal_rujukan" placeholder="<?= HtmlEncode($Page->tanggal_rujukan->getPlaceHolder()) ?>" value="<?= $Page->tanggal_rujukan->EditValue ?>"<?= $Page->tanggal_rujukan->editAttributes() ?>>
...
<script>
loadjs.ready(["fPASIEN_VISITATIONsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIEN_VISITATIONsearch", "x_tanggal_rujukan", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<template id="tp_x_ISRJ">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="PASIEN_VISITATION" data-field="x_ISRJ" name="x_ISRJ" id="x_ISRJ"<?= $Page->ISRJ->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->PPKRUJUKAN->Visible) { // PPKRUJUKAN ?>
    <div id="r_PPKRUJUKAN" class="form-group row">
        <label for="x_PPKRUJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_PPKRUJUKAN"><?= $Page->PPKRUJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<?php if ($Page->DIAG_AWAL->Visible) { // DIAG_AWAL ?>
    <div id="r_DIAG_AWAL" class="form-group row">
        <label for="x_DIAG_AWAL" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_DIAG_AWAL"><?= $Page->DIAG_AWAL->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->DIAG_AWAL->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_DIAG_AWAL" name="x_DIAG_AWAL" id="x_DIAG_AWAL" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->DIAG_AWAL->getPlaceHolder()) ?>" value="<?= $Page->DIAG_AWAL->EditValue ?>"<?= $Page->DIAG_AWAL->editAttributes() ?>>
...
<?php if ($Page->KDPOLI_EKS->Visible) { // KDPOLI_EKS ?>
    <div id="r_KDPOLI_EKS" class="form-group row">
        <label for="x_KDPOLI_EKS" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_KDPOLI_EKS"><?= $Page->KDPOLI_EKS->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<input type="<?= $Page->KDPOLI_EKS->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_KDPOLI_EKS" name="x_KDPOLI_EKS" id="x_KDPOLI_EKS" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->KDPOLI_EKS->getPlaceHolder()) ?>" value="<?= $Page->KDPOLI_EKS->EditValue ?>"<?= $Page->KDPOLI_EKS->editAttributes() ?>>
...
<input type="<?= $Page->ASALRUJUKAN->getInputTextType() ?>" data-table="PASIEN_VISITATION" data-field="x_ASALRUJUKAN" name="x_ASALRUJUKAN" id="x_ASALRUJUKAN" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ASALRUJUKAN->getPlaceHolder()) ?>" value="<?= $Page->ASALRUJUKAN->EditValue ?>"<?= $Page->ASALRUJUKAN->editAttributes() ?>>
...
<?php if ($Page->CALL_TIMES->Visible) { // CALL_TIMES ?>
    <div id="r_CALL_TIMES" class="form-group row">
        <label for="x_CALL_TIMES" class="<?= $Page->LeftColumnClass ?>"><span id="elh_PASIEN_VISITATION_CALL_TIMES"><?= $Page->CALL_TIMES->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
