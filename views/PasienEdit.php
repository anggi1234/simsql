...
loadjs.ready("head", function () {
    ...
    fPASIENedit.lists.FAMILY_STATUS_ID = <?= $Page->FAMILY_STATUS_ID->toClientList($Page) ?>;
    ...
    fPASIENedit.lists.AKTIF = <?= $Page->AKTIF->toClientList($Page) ?>;
...
<input type="hidden" data-table="PASIEN" data-field="x_REGISTRATION_DATE" data-hidden="1" name="x_REGISTRATION_DATE" id="x_REGISTRATION_DATE" value="<?= HtmlEncode($Page->REGISTRATION_DATE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fPASIENedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENedit", "x_TMT", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPASIENedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENedit", "x_TAT", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
