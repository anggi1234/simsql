...
loadjs.ready("head", function () {
    ...
    fMEASUREMENTadd = currentForm = new ew.Form("fMEASUREMENTadd", "add");
    ...
    // Validate form
    fMEASUREMENTadd.validate = function () {
    ...
    // Form_CustomValidate
    fMEASUREMENTadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fMEASUREMENTadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fMEASUREMENTadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fMEASUREMENTadd" id="fMEASUREMENTadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
