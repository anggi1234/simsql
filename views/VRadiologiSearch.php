...
<input type="<?= $Page->BOOKED_DATE->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_BOOKED_DATE" data-format="11" name="x_BOOKED_DATE" id="x_BOOKED_DATE" placeholder="<?= HtmlEncode($Page->BOOKED_DATE->getPlaceHolder()) ?>" value="<?= $Page->BOOKED_DATE->EditValue ?>"<?= $Page->BOOKED_DATE->editAttributes() ?>>
...
loadjs.ready(["fV_RADIOLOGIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_RADIOLOGIsearch", "x_BOOKED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->VISIT_DATE->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_VISIT_DATE" data-format="11" name="x_VISIT_DATE" id="x_VISIT_DATE" placeholder="<?= HtmlEncode($Page->VISIT_DATE->getPlaceHolder()) ?>" value="<?= $Page->VISIT_DATE->EditValue ?>"<?= $Page->VISIT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_RADIOLOGIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_RADIOLOGIsearch", "x_VISIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->MODIFIED_DATE->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_MODIFIED_DATE" data-format="11" name="x_MODIFIED_DATE" id="x_MODIFIED_DATE" placeholder="<?= HtmlEncode($Page->MODIFIED_DATE->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_DATE->EditValue ?>"<?= $Page->MODIFIED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_RADIOLOGIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_RADIOLOGIsearch", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->IDXDAFTAR->getInputTextType() ?>" data-table="V_RADIOLOGI" data-field="x_IDXDAFTAR" name="x_IDXDAFTAR" id="x_IDXDAFTAR" maxlength="50" placeholder="<?= HtmlEncode($Page->IDXDAFTAR->getPlaceHolder()) ?>" value="<?= $Page->IDXDAFTAR->EditValue ?>"<?= $Page->IDXDAFTAR->editAttributes() ?>>
