...
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <tr id="r_NO_REGISTRATION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_NO_REGISTRATION"><?= $Page->NO_REGISTRATION->caption() ?></span></td>
...
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
    <tr id="r_VISIT_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_VISIT_ID"><?= $Page->VISIT_ID->caption() ?></span></td>
...
<?php if ($Page->THENAME->Visible) { // THENAME ?>
    <tr id="r_THENAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_THENAME"><?= $Page->THENAME->caption() ?></span></td>
...
<?php if ($Page->THEADDRESS->Visible) { // THEADDRESS ?>
    <tr id="r_THEADDRESS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_THEADDRESS"><?= $Page->THEADDRESS->caption() ?></span></td>
...
<?php if ($Page->NOTA_NO->Visible) { // NOTA_NO ?>
    <tr id="r_NOTA_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_NOTA_NO"><?= $Page->NOTA_NO->caption() ?></span></td>
...
<?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
    <tr id="r_TRANS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_TREATMENT_AKOMODASI_TRANS_ID"><?= $Page->TRANS_ID->caption() ?></span></td>
