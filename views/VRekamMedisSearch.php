...
loadjs.ready("head", function () {
    ...
    fV_REKAM_MEDISsearch.lists.ISNEW = <?= $Page->ISNEW->toClientList($Page) ?>;
    fV_REKAM_MEDISsearch.lists.CLINIC_ID = <?= $Page->CLINIC_ID->toClientList($Page) ?>;
    fV_REKAM_MEDISsearch.lists.CLINIC_ID_FROM = <?= $Page->CLINIC_ID_FROM->toClientList($Page) ?>;
...
<input type="<?= $Page->BOOKED_DATE->getInputTextType() ?>" data-table="V_REKAM_MEDIS" data-field="x_BOOKED_DATE" data-format="11" name="x_BOOKED_DATE" id="x_BOOKED_DATE" placeholder="<?= HtmlEncode($Page->BOOKED_DATE->getPlaceHolder()) ?>" value="<?= $Page->BOOKED_DATE->EditValue ?>"<?= $Page->BOOKED_DATE->editAttributes() ?>>
...
loadjs.ready(["fV_REKAM_MEDISsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_REKAM_MEDISsearch", "x_BOOKED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISNEW->Visible) { // ISNEW ?>
    <div id="r_ISNEW" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_REKAM_MEDIS_ISNEW"><?= $Page->ISNEW->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
...
<template id="tp_x_ISNEW">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="V_REKAM_MEDIS" data-field="x_ISNEW" name="x_ISNEW" id="x_ISNEW"<?= $Page->ISNEW->editAttributes() ?>>
...
<input type="hidden" name="z_CLINIC_ID_FROM" id="z_CLINIC_ID_FROM" value="LIKE">
    ...
    <select
        ...
        data-select2-id="V_REKAM_MEDIS_x_CLINIC_ID_FROM"
        data-table="V_REKAM_MEDIS"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='V_REKAM_MEDIS_x_CLINIC_ID_FROM']"),
        options = { name: "x_CLINIC_ID_FROM", selectId: "V_REKAM_MEDIS_x_CLINIC_ID_FROM", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.V_REKAM_MEDIS.fields.CLINIC_ID_FROM.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<input type="<?= $Page->MODIFIED_DATE->getInputTextType() ?>" data-table="V_REKAM_MEDIS" data-field="x_MODIFIED_DATE" data-format="11" name="x_MODIFIED_DATE" id="x_MODIFIED_DATE" placeholder="<?= HtmlEncode($Page->MODIFIED_DATE->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_DATE->EditValue ?>"<?= $Page->MODIFIED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_REKAM_MEDISsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_REKAM_MEDISsearch", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<template id="tp_x_COB">
    <div class="custom-control custom-checkbox">
        <input type="checkbox" class="custom-control-input" data-table="V_REKAM_MEDIS" data-field="x_COB" name="x_COB" id="x_COB"<?= $Page->COB->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<input type="<?= $Page->IDXDAFTAR->getInputTextType() ?>" data-table="V_REKAM_MEDIS" data-field="x_IDXDAFTAR" name="x_IDXDAFTAR" id="x_IDXDAFTAR" maxlength="50" placeholder="<?= HtmlEncode($Page->IDXDAFTAR->getPlaceHolder()) ?>" value="<?= $Page->IDXDAFTAR->EditValue ?>"<?= $Page->IDXDAFTAR->editAttributes() ?>>
