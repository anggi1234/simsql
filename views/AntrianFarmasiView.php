...
// Page object
$AntrianFarmasiView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fANTRIAN_FARMASIview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fANTRIAN_FARMASIview = currentForm = new ew.Form("fANTRIAN_FARMASIview", "view");
    loadjs.done("fANTRIAN_FARMASIview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTRIAN_FARMASIview" id="fANTRIAN_FARMASIview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Id->Visible) { // Id ?>
    <tr id="r_Id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_Id"><?= $Page->Id->caption() ?></span></td>
        <td data-name="Id" <?= $Page->Id->cellAttributes() ?>>
<span id="el_ANTRIAN_FARMASI_Id">
...
<?php if ($Page->no_urut->Visible) { // no_urut ?>
    <tr id="r_no_urut">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_no_urut"><?= $Page->no_urut->caption() ?></span></td>
...
<?php if ($Page->tanggal_daftar->Visible) { // tanggal_daftar ?>
    <tr id="r_tanggal_daftar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_tanggal_daftar"><?= $Page->tanggal_daftar->caption() ?></span></td>
...
<?php if ($Page->tanggal_panggil->Visible) { // tanggal_panggil ?>
    <tr id="r_tanggal_panggil">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_tanggal_panggil"><?= $Page->tanggal_panggil->caption() ?></span></td>
...
<?php if ($Page->loket->Visible) { // loket ?>
    <tr id="r_loket">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_loket"><?= $Page->loket->caption() ?></span></td>
...
<?php if ($Page->status_panggil->Visible) { // status_panggil ?>
    <tr id="r_status_panggil">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_status_panggil"><?= $Page->status_panggil->caption() ?></span></td>
...
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <tr id="r_NO_REGISTRATION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_NO_REGISTRATION"><?= $Page->NO_REGISTRATION->caption() ?></span></td>
...
<?php if ($Page->THENAME->Visible) { // THENAME ?>
    <tr id="r_THENAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_THENAME"><?= $Page->THENAME->caption() ?></span></td>
...
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
    <tr id="r_VISIT_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_FARMASI_VISIT_ID"><?= $Page->VISIT_ID->caption() ?></span></td>
