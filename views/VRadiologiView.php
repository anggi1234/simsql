...
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
    <tr id="r_VISIT_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_VISIT_ID"><?= $Page->VISIT_ID->caption() ?></span></td>
...
<?php if ($Page->VISITOR_ADDRESS->Visible) { // VISITOR_ADDRESS ?>
    <tr id="r_VISITOR_ADDRESS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_VISITOR_ADDRESS"><?= $Page->VISITOR_ADDRESS->caption() ?></span></td>
...
<?php if ($Page->TICKET_NO->Visible) { // TICKET_NO ?>
    <tr id="r_TICKET_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_TICKET_NO"><?= $Page->TICKET_NO->caption() ?></span></td>
...
<?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
    <tr id="r_TRANS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_TRANS_ID"><?= $Page->TRANS_ID->caption() ?></span></td>
...
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
    <tr id="r_IDXDAFTAR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_IDXDAFTAR"><?= $Page->IDXDAFTAR->caption() ?></span></td>
