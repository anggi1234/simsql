...
<?php if ($Grid->RESEP_NO->Visible) { // RESEP_NO ?>
        <th data-name="RESEP_NO" class="<?= $Grid->RESEP_NO->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_RESEP_NO" class="TREATMENT_OBAT_RESEP_NO"><?= $Grid->renderSort($Grid->RESEP_NO) ?></div></th>
<?php } ?>
<?php if ($Grid->TARIF_ID->Visible) { // TARIF_ID ?>
        <th data-name="TARIF_ID" class="<?= $Grid->TARIF_ID->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_TARIF_ID" class="TREATMENT_OBAT_TARIF_ID"><?= $Grid->renderSort($Grid->TARIF_ID) ?></div></th>
<?php } ?>
<?php if ($Grid->TREAT_DATE->Visible) { // TREAT_DATE ?>
        <th data-name="TREAT_DATE" class="<?= $Grid->TREAT_DATE->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_TREAT_DATE" class="TREATMENT_OBAT_TREAT_DATE"><?= $Grid->renderSort($Grid->TREAT_DATE) ?></div></th>
<?php } ?>
<?php if ($Grid->MEASURE_ID->Visible) { // MEASURE_ID ?>
        <th data-name="MEASURE_ID" class="<?= $Grid->MEASURE_ID->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_MEASURE_ID" class="TREATMENT_OBAT_MEASURE_ID"><?= $Grid->renderSort($Grid->MEASURE_ID) ?></div></th>
<?php } ?>
<?php if ($Grid->DESCRIPTION->Visible) { // DESCRIPTION ?>
        <th data-name="DESCRIPTION" class="<?= $Grid->DESCRIPTION->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_DESCRIPTION" class="TREATMENT_OBAT_DESCRIPTION"><?= $Grid->renderSort($Grid->DESCRIPTION) ?></div></th>
<?php } ?>
<?php if ($Grid->DOSE_PRESC->Visible) { // DOSE_PRESC ?>
        <th data-name="DOSE_PRESC" class="<?= $Grid->DOSE_PRESC->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_DOSE_PRESC" class="TREATMENT_OBAT_DOSE_PRESC"><?= $Grid->renderSort($Grid->DOSE_PRESC) ?></div></th>
<?php } ?>
<?php if ($Grid->BRAND_ID->Visible) { // BRAND_ID ?>
        <th data-name="BRAND_ID" class="<?= $Grid->BRAND_ID->headerCellClass() ?>"><div id="elh_TREATMENT_OBAT_BRAND_ID" class="TREATMENT_OBAT_BRAND_ID"><?= $Grid->renderSort($Grid->BRAND_ID) ?></div></th>
<?php } ?>
