...
<?php if ($Page->TREAT_DATE->Visible) { // TREAT_DATE ?>
        <th data-name="TREAT_DATE" class="<?= $Page->TREAT_DATE->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_TREAT_DATE" class="TREATMENT_BILL_TREAT_DATE"><?= $Page->renderSort($Page->TREAT_DATE) ?></div></th>
<?php } ?>
<?php if ($Page->AMOUNT->Visible) { // AMOUNT ?>
        <th data-name="AMOUNT" class="<?= $Page->AMOUNT->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_AMOUNT" class="TREATMENT_BILL_AMOUNT"><?= $Page->renderSort($Page->AMOUNT) ?></div></th>
<?php } ?>
<?php if ($Page->QUANTITY->Visible) { // QUANTITY ?>
        <th data-name="QUANTITY" class="<?= $Page->QUANTITY->headerCellClass() ?>"><div id="elh_TREATMENT_BILL_QUANTITY" class="TREATMENT_BILL_QUANTITY"><?= $Page->renderSort($Page->QUANTITY) ?></div></th>
<?php } ?>
...
<?php if ($Page->profession->Visible) { // profession ?>
        <th data-name="profession" class="<?= $Page->profession->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_TREATMENT_BILL_profession" class="TREATMENT_BILL_profession"><?= $Page->renderSort($Page->profession) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_TREATMENT_BILL_profession">
...
?>
    ...
    <?php } ?>
    <?php if ($Page->profession->Visible) { // profession ?>
        <td data-name="profession" class="<?= $Page->profession->footerCellClass() ?>"><span id="elf_TREATMENT_BILL_profession" class="TREATMENT_BILL_profession">
        &nbsp;
        </span></td>
    <?php } ?>
    <?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
