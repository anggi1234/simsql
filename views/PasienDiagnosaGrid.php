...
<?php if ($Grid->PASIEN_DIAGNOSA_ID->Visible) { // PASIEN_DIAGNOSA_ID ?>
        <th data-name="PASIEN_DIAGNOSA_ID" class="<?= $Grid->PASIEN_DIAGNOSA_ID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID"><?= $Grid->renderSort($Grid->PASIEN_DIAGNOSA_ID) ?></div></th>
<?php } ?>
...
<span id="el<?= $Grid->RowCount ?>_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="form-group">
...
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" data-hidden="1" name="o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" value="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->OldValue) ?>">
<?php } ?>
...
<span id="el<?= $Grid->RowCount ?>_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID">
<span<?= $Grid->PASIEN_DIAGNOSA_ID->viewAttributes() ?>>
<?= $Grid->PASIEN_DIAGNOSA_ID->getViewValue() ?></span>
</span>
<?php if ($Grid->isConfirm()) { ?>
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" data-hidden="1" name="fPASIEN_DIAGNOSAgrid$x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="fPASIEN_DIAGNOSAgrid$x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" value="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->FormValue) ?>">
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" data-hidden="1" name="fPASIEN_DIAGNOSAgrid$o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="fPASIEN_DIAGNOSAgrid$o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" value="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
    <?php } ?>
...
<?php } else { ?>
<span id="el<?= $Grid->RowCount ?>_PASIEN_DIAGNOSA_VISIT_ID" class="form-group">
<input type="<?= $Grid->VISIT_ID->getInputTextType() ?>" data-table="PASIEN_DIAGNOSA" data-field="x_VISIT_ID" name="x<?= $Grid->RowIndex ?>_VISIT_ID" id="x<?= $Grid->RowIndex ?>_VISIT_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Grid->VISIT_ID->getPlaceHolder()) ?>" value="<?= $Grid->VISIT_ID->EditValue ?>"<?= $Grid->VISIT_ID->editAttributes() ?>>
...
<?php if (!$Grid->isConfirm()) { ?>
<span id="el$rowindex$_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="form-group PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID">
<input type="<?= $Grid->PASIEN_DIAGNOSA_ID->getInputTextType() ?>" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" name="x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->getPlaceHolder()) ?>" value="<?= $Grid->PASIEN_DIAGNOSA_ID->EditValue ?>"<?= $Grid->PASIEN_DIAGNOSA_ID->editAttributes() ?>>
<div class="invalid-feedback"><?= $Grid->PASIEN_DIAGNOSA_ID->getErrorMessage() ?></div>
</span>
<?php } else { ?>
...
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" data-hidden="1" name="x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="x<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" value="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="PASIEN_DIAGNOSA" data-field="x_PASIEN_DIAGNOSA_ID" data-hidden="1" name="o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" id="o<?= $Grid->RowIndex ?>_PASIEN_DIAGNOSA_ID" value="<?= HtmlEncode($Grid->PASIEN_DIAGNOSA_ID->OldValue) ?>">
</td>
    <?php } ?>
