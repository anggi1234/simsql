...
<input type="hidden" data-table="TREATMENT_BILL" data-field="x_ISRJ" data-hidden="1" name="x_ISRJ" id="x_ISRJ" value="<?= HtmlEncode($Page->ISRJ->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->ID->Visible) { // ID ?>
    <div id="r_ID" class="form-group row">
        <label id="elh_TREATMENT_BILL_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ID->caption() ?><?= $Page->ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
