...
var fANTRIAN_POLIadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fANTRIAN_POLIadd = currentForm = new ew.Form("fANTRIAN_POLIadd", "add");
    ...
    // Validate form
    fANTRIAN_POLIadd.validate = function () {
    ...
    // Form_CustomValidate
    fANTRIAN_POLIadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fANTRIAN_POLIadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fANTRIAN_POLIadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTRIAN_POLIadd" id="fANTRIAN_POLIadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fANTRIAN_POLIadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_POLIadd", "x_tanggal_daftar", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_POLIadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_POLIadd", "x_tanggal_panggil", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
