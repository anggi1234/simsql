...
// Page object
$PoInvoiceitemAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fPO_INVOICEITEMadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fPO_INVOICEITEMadd = currentForm = new ew.Form("fPO_INVOICEITEMadd", "add");
    ...
    // Validate form
    fPO_INVOICEITEMadd.validate = function () {
    ...
    // Form_CustomValidate
    fPO_INVOICEITEMadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPO_INVOICEITEMadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPO_INVOICEITEMadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPO_INVOICEITEMadd" id="fPO_INVOICEITEMadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fPO_INVOICEITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMadd", "x_ORDER_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMadd", "x_ATP_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMadd", "x_DELIVERY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":111});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMadd", "x_PRINT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fPO_INVOICEITEMadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPO_INVOICEITEMadd", "x_EXPIRY_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
