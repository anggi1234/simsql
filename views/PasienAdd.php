...
loadjs.ready("head", function () {
    ...
    fPASIENadd.addFields([
        ...
        ["BLOOD_TYPE_ID", [fields.BLOOD_TYPE_ID.visible && fields.BLOOD_TYPE_ID.required ? ew.Validators.required(fields.BLOOD_TYPE_ID.caption) : null], fields.BLOOD_TYPE_ID.isInvalid],
    ...
    fPASIENadd.lists.GENDER = <?= $Page->GENDER->toClientList($Page) ?>;
    fPASIENadd.lists.EDUCATION_TYPE_CODE = <?= $Page->EDUCATION_TYPE_CODE->toClientList($Page) ?>;
    fPASIENadd.lists.MARITALSTATUSID = <?= $Page->MARITALSTATUSID->toClientList($Page) ?>;
    fPASIENadd.lists.KODE_AGAMA = <?= $Page->KODE_AGAMA->toClientList($Page) ?>;
    fPASIENadd.lists.KAL_ID = <?= $Page->KAL_ID->toClientList($Page) ?>;
    fPASIENadd.lists.JOB_ID = <?= $Page->JOB_ID->toClientList($Page) ?>;
    fPASIENadd.lists.STATUS_PASIEN_ID = <?= $Page->STATUS_PASIEN_ID->toClientList($Page) ?>;
    fPASIENadd.lists.BLOOD_TYPE_ID = <?= $Page->BLOOD_TYPE_ID->toClientList($Page) ?>;
    fPASIENadd.lists.FAMILY_STATUS_ID = <?= $Page->FAMILY_STATUS_ID->toClientList($Page) ?>;
    fPASIENadd.lists.PAYOR_ID = <?= $Page->PAYOR_ID->toClientList($Page) ?>;
    fPASIENadd.lists.CLASS_ID = <?= $Page->CLASS_ID->toClientList($Page) ?>;
    fPASIENadd.lists.COVERAGE_ID = <?= $Page->COVERAGE_ID->toClientList($Page) ?>;
    fPASIENadd.lists.AKTIF = <?= $Page->AKTIF->toClientList($Page) ?>;
...
loadjs.ready(["fPASIENadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENadd", "x_DATE_OF_BIRTH", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->KODE_AGAMA->Visible) { // KODE_AGAMA ?>
    <div id="r_KODE_AGAMA" class="form-group row">
        <label id="elh_PASIEN_KODE_AGAMA" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KODE_AGAMA->caption() ?><?= $Page->KODE_AGAMA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_KODE_AGAMA">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="PASIEN" data-field="x_KODE_AGAMA" name="x_KODE_AGAMA" id="x_KODE_AGAMA"<?= $Page->KODE_AGAMA->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
    <div id="r_STATUS_PASIEN_ID" class="form-group row">
        <label id="elh_PASIEN_STATUS_PASIEN_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->STATUS_PASIEN_ID->caption() ?><?= $Page->STATUS_PASIEN_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STATUS_PASIEN_ID->cellAttributes() ?>>
<span id="el_PASIEN_STATUS_PASIEN_ID">
<template id="tp_x_STATUS_PASIEN_ID">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="PASIEN" data-field="x_STATUS_PASIEN_ID" name="x_STATUS_PASIEN_ID" id="x_STATUS_PASIEN_ID"<?= $Page->STATUS_PASIEN_ID->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
<div id="dsl_x_STATUS_PASIEN_ID" class="ew-item-list"></div>
<input type="hidden"
    is="selection-list"
    id="x_STATUS_PASIEN_ID"
    name="x_STATUS_PASIEN_ID"
    value="<?= HtmlEncode($Page->STATUS_PASIEN_ID->CurrentValue) ?>"
    data-type="select-one"
    data-template="tp_x_STATUS_PASIEN_ID"
    data-target="dsl_x_STATUS_PASIEN_ID"
    data-repeatcolumn="5"
    class="form-control<?= $Page->STATUS_PASIEN_ID->isInvalidClass() ?>"
    data-table="PASIEN"
...
<input type="<?= $Page->MOBILE->getInputTextType() ?>" data-table="PASIEN" data-field="x_MOBILE" name="x_MOBILE" id="x_MOBILE" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->MOBILE->getPlaceHolder()) ?>" value="<?= $Page->MOBILE->EditValue ?>"<?= $Page->MOBILE->editAttributes() ?> aria-describedby="x_MOBILE_help">
...
<?php if ($Page->POSTAL_CODE->Visible) { // POSTAL_CODE ?>
    <div id="r_POSTAL_CODE" class="form-group row">
        <label id="elh_PASIEN_POSTAL_CODE" for="x_POSTAL_CODE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->POSTAL_CODE->caption() ?><?= $Page->POSTAL_CODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->POSTAL_CODE->cellAttributes() ?>>
<span id="el_PASIEN_POSTAL_CODE">
<input type="<?= $Page->POSTAL_CODE->getInputTextType() ?>" data-table="PASIEN" data-field="x_POSTAL_CODE" name="x_POSTAL_CODE" id="x_POSTAL_CODE" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->POSTAL_CODE->getPlaceHolder()) ?>" value="<?= $Page->POSTAL_CODE->EditValue ?>"<?= $Page->POSTAL_CODE->editAttributes() ?> aria-describedby="x_POSTAL_CODE_help">
...
<?php if ($Page->BLOOD_TYPE_ID->Visible) { // BLOOD_TYPE_ID ?>
    <div id="r_BLOOD_TYPE_ID" class="form-group row">
        <label id="elh_PASIEN_BLOOD_TYPE_ID" for="x_BLOOD_TYPE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->BLOOD_TYPE_ID->caption() ?><?= $Page->BLOOD_TYPE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BLOOD_TYPE_ID->cellAttributes() ?>>
<span id="el_PASIEN_BLOOD_TYPE_ID">
    <select
        id="x_BLOOD_TYPE_ID"
        name="x_BLOOD_TYPE_ID"
        class="form-control ew-select<?= $Page->BLOOD_TYPE_ID->isInvalidClass() ?>"
        data-select2-id="PASIEN_x_BLOOD_TYPE_ID"
        data-table="PASIEN"
        data-field="x_BLOOD_TYPE_ID"
        data-value-separator="<?= $Page->BLOOD_TYPE_ID->displayValueSeparatorAttribute() ?>"
        data-placeholder="<?= HtmlEncode($Page->BLOOD_TYPE_ID->getPlaceHolder()) ?>"
        <?= $Page->BLOOD_TYPE_ID->editAttributes() ?>>
        <?= $Page->BLOOD_TYPE_ID->selectOptionListHtml("x_BLOOD_TYPE_ID") ?>
    </select>
    <?= $Page->BLOOD_TYPE_ID->getCustomMessage() ?>
    <div class="invalid-feedback"><?= $Page->BLOOD_TYPE_ID->getErrorMessage() ?></div>
<?= $Page->BLOOD_TYPE_ID->Lookup->getParamTag($Page, "p_x_BLOOD_TYPE_ID") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_x_BLOOD_TYPE_ID']"),
        options = { name: "x_BLOOD_TYPE_ID", selectId: "PASIEN_x_BLOOD_TYPE_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN.fields.BLOOD_TYPE_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_PASIEN_FAMILY_STATUS_ID">
    <select
        ...
        data-select2-id="PASIEN_x_FAMILY_STATUS_ID"
        data-table="PASIEN"
...
<?= $Page->FAMILY_STATUS_ID->Lookup->getParamTag($Page, "p_x_FAMILY_STATUS_ID") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_x_FAMILY_STATUS_ID']"),
        options = { name: "x_FAMILY_STATUS_ID", selectId: "PASIEN_x_FAMILY_STATUS_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN.fields.FAMILY_STATUS_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->COVERAGE_ID->Visible) { // COVERAGE_ID ?>
    <div id="r_COVERAGE_ID" class="form-group row">
        <label id="elh_PASIEN_COVERAGE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->COVERAGE_ID->caption() ?><?= $Page->COVERAGE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<template id="tp_x_COVERAGE_ID">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="PASIEN" data-field="x_COVERAGE_ID" name="x_COVERAGE_ID" id="x_COVERAGE_ID"<?= $Page->COVERAGE_ID->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<input type="<?= $Page->MOTHER->getInputTextType() ?>" data-table="PASIEN" data-field="x_MOTHER" name="x_MOTHER" id="x_MOTHER" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->MOTHER->getPlaceHolder()) ?>" value="<?= $Page->MOTHER->EditValue ?>"<?= $Page->MOTHER->editAttributes() ?> aria-describedby="x_MOTHER_help">
...
<input type="<?= $Page->FATHER->getInputTextType() ?>" data-table="PASIEN" data-field="x_FATHER" name="x_FATHER" id="x_FATHER" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->FATHER->getPlaceHolder()) ?>" value="<?= $Page->FATHER->EditValue ?>"<?= $Page->FATHER->editAttributes() ?> aria-describedby="x_FATHER_help">
...
<input type="<?= $Page->SPOUSE->getInputTextType() ?>" data-table="PASIEN" data-field="x_SPOUSE" name="x_SPOUSE" id="x_SPOUSE" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->SPOUSE->getPlaceHolder()) ?>" value="<?= $Page->SPOUSE->EditValue ?>"<?= $Page->SPOUSE->editAttributes() ?> aria-describedby="x_SPOUSE_help">
...
<?php if ($Page->AKTIF->Visible) { // AKTIF ?>
    <div id="r_AKTIF" class="form-group row">
        <label id="elh_PASIEN_AKTIF" for="x_AKTIF" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AKTIF->caption() ?><?= $Page->AKTIF->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_PASIEN_AKTIF">
    <select
        ...
        data-select2-id="PASIEN_x_AKTIF"
        data-table="PASIEN"
        data-field="x_AKTIF"
...
<?= $Page->AKTIF->Lookup->getParamTag($Page, "p_x_AKTIF") ?>
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='PASIEN_x_AKTIF']"),
        options = { name: "x_AKTIF", selectId: "PASIEN_x_AKTIF", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.PASIEN.fields.AKTIF.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<input type="<?= $Page->TMT->getInputTextType() ?>" data-table="PASIEN" data-field="x_TMT" data-format="11" name="x_TMT" id="x_TMT" placeholder="<?= HtmlEncode($Page->TMT->getPlaceHolder()) ?>" value="<?= $Page->TMT->EditValue ?>"<?= $Page->TMT->editAttributes() ?> aria-describedby="x_TMT_help">
...
<script>
loadjs.ready(["fPASIENadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENadd", "x_TMT", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->TAT->getInputTextType() ?>" data-table="PASIEN" data-field="x_TAT" data-format="11" name="x_TAT" id="x_TAT" placeholder="<?= HtmlEncode($Page->TAT->getPlaceHolder()) ?>" value="<?= $Page->TAT->EditValue ?>"<?= $Page->TAT->editAttributes() ?> aria-describedby="x_TAT_help">
...
<script>
loadjs.ready(["fPASIENadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fPASIENadd", "x_TAT", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<textarea data-table="PASIEN" data-field="x_MEDICAL_NOTES" name="x_MEDICAL_NOTES" id="x_MEDICAL_NOTES" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->MEDICAL_NOTES->getPlaceHolder()) ?>"<?= $Page->MEDICAL_NOTES->editAttributes() ?> aria-describedby="x_MEDICAL_NOTES_help"><?= $Page->MEDICAL_NOTES->EditValue ?></textarea>
