...
<?php if ($Page->PASIEN_DIAGNOSA_ID->Visible) { // PASIEN_DIAGNOSA_ID ?>
        <th class="<?= $Page->PASIEN_DIAGNOSA_ID->headerCellClass() ?>"><span id="elh_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID"><?= $Page->PASIEN_DIAGNOSA_ID->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID">
