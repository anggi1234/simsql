...
<?php if ($Page->DOC_NO->Visible) { // DOC_NO ?>
        <th data-name="DOC_NO" class="<?= $Page->DOC_NO->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_DOC_NO" class="MUTATION_DOCS_DOC_NO"><?= $Page->renderSort($Page->DOC_NO) ?></div></th>
<?php } ?>
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
        <th data-name="CLINIC_ID" class="<?= $Page->CLINIC_ID->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_CLINIC_ID" class="MUTATION_DOCS_CLINIC_ID"><?= $Page->renderSort($Page->CLINIC_ID) ?></div></th>
<?php } ?>
<?php if ($Page->CLINIC_ID_TO->Visible) { // CLINIC_ID_TO ?>
        <th data-name="CLINIC_ID_TO" class="<?= $Page->CLINIC_ID_TO->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_CLINIC_ID_TO" class="MUTATION_DOCS_CLINIC_ID_TO"><?= $Page->renderSort($Page->CLINIC_ID_TO) ?></div></th>
<?php } ?>
<?php if ($Page->MUTATION_DATE->Visible) { // MUTATION_DATE ?>
        <th data-name="MUTATION_DATE" class="<?= $Page->MUTATION_DATE->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_MUTATION_DATE" class="MUTATION_DOCS_MUTATION_DATE"><?= $Page->renderSort($Page->MUTATION_DATE) ?></div></th>
<?php } ?>
<?php if ($Page->MUTATION_BY->Visible) { // MUTATION_BY ?>
        <th data-name="MUTATION_BY" class="<?= $Page->MUTATION_BY->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_MUTATION_BY" class="MUTATION_DOCS_MUTATION_BY"><?= $Page->renderSort($Page->MUTATION_BY) ?></div></th>
<?php } ?>
<?php if ($Page->ORDER_VALUE->Visible) { // ORDER_VALUE ?>
        <th data-name="ORDER_VALUE" class="<?= $Page->ORDER_VALUE->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_ORDER_VALUE" class="MUTATION_DOCS_ORDER_VALUE"><?= $Page->renderSort($Page->ORDER_VALUE) ?></div></th>
<?php } ?>
<?php if ($Page->MUTATION_VALUE->Visible) { // MUTATION_VALUE ?>
        <th data-name="MUTATION_VALUE" class="<?= $Page->MUTATION_VALUE->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_MUTATION_VALUE" class="MUTATION_DOCS_MUTATION_VALUE"><?= $Page->renderSort($Page->MUTATION_VALUE) ?></div></th>
<?php } ?>
<?php if ($Page->RECEIVED_BY->Visible) { // RECEIVED_BY ?>
        <th data-name="RECEIVED_BY" class="<?= $Page->RECEIVED_BY->headerCellClass() ?>"><div id="elh_MUTATION_DOCS_RECEIVED_BY" class="MUTATION_DOCS_RECEIVED_BY"><?= $Page->renderSort($Page->RECEIVED_BY) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_MUTATION_DOCS_DOC_NO">
...
<?= $Page->MUTATION_DATE->getViewValue() ?></span>
    ...
    <?php } ?>
    <?php if ($Page->MUTATION_BY->Visible) { // MUTATION_BY ?>
        <td data-name="MUTATION_BY" <?= $Page->MUTATION_BY->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_MUTATION_DOCS_MUTATION_BY">
<span<?= $Page->MUTATION_BY->viewAttributes() ?>>
<?= $Page->MUTATION_BY->getViewValue() ?></span>
</span>
</td>
    <?php } ?>
    <?php if ($Page->ORDER_VALUE->Visible) { // ORDER_VALUE ?>
