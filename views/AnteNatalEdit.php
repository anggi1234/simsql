...
loadjs.ready("head", function () {
    ...
    fANTE_NATALedit = currentForm = new ew.Form("fANTE_NATALedit", "edit");
    ...
    // Validate form
    fANTE_NATALedit.validate = function () {
    ...
    // Form_CustomValidate
    fANTE_NATALedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fANTE_NATALedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fANTE_NATALedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTE_NATALedit" id="fANTE_NATALedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="ANTE_NATAL" data-field="x_ANTE_NATAL" data-hidden="1" name="o_ANTE_NATAL" id="o_ANTE_NATAL" value="<?= HtmlEncode($Page->ANTE_NATAL->OldValue ?? $Page->ANTE_NATAL->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
