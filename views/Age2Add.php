...
loadjs.ready("head", function () {
    ...
    fAGE2add = currentForm = new ew.Form("fAGE2add", "add");
    ...
    // Form_CustomValidate
    fAGE2add.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fAGE2add.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fAGE2add");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fAGE2add" id="fAGE2add" class="<?= $Page->FormClassName ?>" action="<?= HtmlEncode(GetUrl(CurrentPageName())) ?>" method="post">
