...
loadjs.ready("head", function () {
    ...
    fPASIEN_DIAGNOSAlistsrch.addFields([
        ["PASIEN_DIAGNOSA_ID", [], fields.PASIEN_DIAGNOSA_ID.isInvalid],
...
<?php if ($Page->PASIEN_DIAGNOSA_ID->Visible) { // PASIEN_DIAGNOSA_ID ?>
        <th data-name="PASIEN_DIAGNOSA_ID" class="<?= $Page->PASIEN_DIAGNOSA_ID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID" class="PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID"><?= $Page->renderSort($Page->PASIEN_DIAGNOSA_ID) ?></div></th>
<?php } ?>
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
        <th data-name="VISIT_ID" class="<?= $Page->VISIT_ID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_DIAGNOSA_VISIT_ID" class="PASIEN_DIAGNOSA_VISIT_ID"><?= $Page->renderSort($Page->VISIT_ID) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_PASIEN_DIAGNOSA_ID">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_DIAGNOSA_VISIT_ID">
