...
loadjs.ready("head", function () {
    ...
    fTREATMENT_AKOMODASIadd.addFields([
        ...
        ["TREAT_DATE", [fields.TREAT_DATE.visible && fields.TREAT_DATE.required ? ew.Validators.required(fields.TREAT_DATE.caption) : null, ew.Validators.datetime(111)], fields.TREAT_DATE.isInvalid],
...
<?php } else { ?>
<span id="el_TREATMENT_AKOMODASI_VISIT_ID">
<input type="<?= $Page->VISIT_ID->getInputTextType() ?>" data-table="TREATMENT_AKOMODASI" data-field="x_VISIT_ID" name="x_VISIT_ID" id="x_VISIT_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->VISIT_ID->getPlaceHolder()) ?>" value="<?= $Page->VISIT_ID->EditValue ?>"<?= $Page->VISIT_ID->editAttributes() ?> aria-describedby="x_VISIT_ID_help">
...
<input type="<?= $Page->TREAT_DATE->getInputTextType() ?>" data-table="TREATMENT_AKOMODASI" data-field="x_TREAT_DATE" data-format="111" name="x_TREAT_DATE" id="x_TREAT_DATE" placeholder="<?= HtmlEncode($Page->TREAT_DATE->getPlaceHolder()) ?>" value="<?= $Page->TREAT_DATE->EditValue ?>"<?= $Page->TREAT_DATE->editAttributes() ?> aria-describedby="x_TREAT_DATE_help">
...
loadjs.ready(["fTREATMENT_AKOMODASIadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fTREATMENT_AKOMODASIadd", "x_TREAT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":111});
});
</script>
<?php } ?>
</span>
...
<input type="<?= $Page->NOTA_NO->getInputTextType() ?>" data-table="TREATMENT_AKOMODASI" data-field="x_NOTA_NO" name="x_NOTA_NO" id="x_NOTA_NO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NOTA_NO->getPlaceHolder()) ?>" value="<?= $Page->NOTA_NO->EditValue ?>"<?= $Page->NOTA_NO->editAttributes() ?> aria-describedby="x_NOTA_NO_help">
...
<?php } else { ?>
<span id="el_TREATMENT_AKOMODASI_TRANS_ID">
<input type="<?= $Page->TRANS_ID->getInputTextType() ?>" data-table="TREATMENT_AKOMODASI" data-field="x_TRANS_ID" name="x_TRANS_ID" id="x_TRANS_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->TRANS_ID->getPlaceHolder()) ?>" value="<?= $Page->TRANS_ID->EditValue ?>"<?= $Page->TRANS_ID->editAttributes() ?> aria-describedby="x_TRANS_ID_help">
