...
// Page object
$AntrianPendaftaranDisabilitasEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fANTRIAN_PENDAFTARAN_DISABILITASedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fANTRIAN_PENDAFTARAN_DISABILITASedit = currentForm = new ew.Form("fANTRIAN_PENDAFTARAN_DISABILITASedit", "edit");
    ...
    fANTRIAN_PENDAFTARAN_DISABILITASedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fANTRIAN_PENDAFTARAN_DISABILITASedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fANTRIAN_PENDAFTARAN_DISABILITASedit.validate = function () {
    ...
    // Form_CustomValidate
    fANTRIAN_PENDAFTARAN_DISABILITASedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fANTRIAN_PENDAFTARAN_DISABILITASedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fANTRIAN_PENDAFTARAN_DISABILITASedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTRIAN_PENDAFTARAN_DISABILITASedit" id="fANTRIAN_PENDAFTARAN_DISABILITASedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Id->Visible) { // Id ?>
    <div id="r_Id" class="form-group row">
        <label id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_Id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Id->caption() ?><?= $Page->Id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->Id->cellAttributes() ?>>
<span id="el_ANTRIAN_PENDAFTARAN_DISABILITAS_Id">
<span<?= $Page->Id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Id->getDisplayValue($Page->Id->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="ANTRIAN_PENDAFTARAN_DISABILITAS" data-field="x_Id" data-hidden="1" name="x_Id" id="x_Id" value="<?= HtmlEncode($Page->Id->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARAN_DISABILITASedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARAN_DISABILITASedit", "x_tanggal_daftar", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARAN_DISABILITASedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARAN_DISABILITASedit", "x_tanggal_panggil", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARAN_DISABILITASedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARAN_DISABILITASedit", "x_tanggal_pesan", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARAN_DISABILITASedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARAN_DISABILITASedit", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
