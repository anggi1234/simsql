...
<?php if ($Page->TICKET_NO->Visible) { // TICKET_NO ?>
    <tr id="r_TICKET_NO">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_LABORATORIUM_TICKET_NO"><?= $Page->TICKET_NO->caption() ?></span></td>
...
<?php if ($Page->AGEYEAR->Visible) { // AGEYEAR ?>
    <tr id="r_AGEYEAR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_LABORATORIUM_AGEYEAR"><?= $Page->AGEYEAR->caption() ?></span></td>
...
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
    <tr id="r_IDXDAFTAR">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_LABORATORIUM_IDXDAFTAR"><?= $Page->IDXDAFTAR->caption() ?></span></td>
