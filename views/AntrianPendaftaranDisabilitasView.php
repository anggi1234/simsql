...
// Page object
$AntrianPendaftaranDisabilitasView = &$Page;
?>
<?php if (!$Page->isExport()) { ?>
<script>
var currentForm, currentPageID;
var fANTRIAN_PENDAFTARAN_DISABILITASview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fANTRIAN_PENDAFTARAN_DISABILITASview = currentForm = new ew.Form("fANTRIAN_PENDAFTARAN_DISABILITASview", "view");
    loadjs.done("fANTRIAN_PENDAFTARAN_DISABILITASview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTRIAN_PENDAFTARAN_DISABILITASview" id="fANTRIAN_PENDAFTARAN_DISABILITASview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->Id->Visible) { // Id ?>
    <tr id="r_Id">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_Id"><?= $Page->Id->caption() ?></span></td>
        <td data-name="Id" <?= $Page->Id->cellAttributes() ?>>
<span id="el_ANTRIAN_PENDAFTARAN_DISABILITAS_Id">
...
<?php if ($Page->no_urut->Visible) { // no_urut ?>
    <tr id="r_no_urut">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_no_urut"><?= $Page->no_urut->caption() ?></span></td>
...
<?php if ($Page->tanggal_daftar->Visible) { // tanggal_daftar ?>
    <tr id="r_tanggal_daftar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tanggal_daftar"><?= $Page->tanggal_daftar->caption() ?></span></td>
...
<?php if ($Page->tanggal_panggil->Visible) { // tanggal_panggil ?>
    <tr id="r_tanggal_panggil">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tanggal_panggil"><?= $Page->tanggal_panggil->caption() ?></span></td>
...
<?php if ($Page->loket->Visible) { // loket ?>
    <tr id="r_loket">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_loket"><?= $Page->loket->caption() ?></span></td>
...
<?php if ($Page->status_panggil->Visible) { // status_panggil ?>
    <tr id="r_status_panggil">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_status_panggil"><?= $Page->status_panggil->caption() ?></span></td>
...
<?php if ($Page->user->Visible) { // user ?>
    <tr id="r_user">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_user"><?= $Page->user->caption() ?></span></td>
...
<?php if ($Page->newapp->Visible) { // newapp ?>
    <tr id="r_newapp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_newapp"><?= $Page->newapp->caption() ?></span></td>
...
<?php if ($Page->kdpoli->Visible) { // kdpoli ?>
    <tr id="r_kdpoli">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_kdpoli"><?= $Page->kdpoli->caption() ?></span></td>
...
<?php if ($Page->tanggal_pesan->Visible) { // tanggal_pesan ?>
    <tr id="r_tanggal_pesan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tanggal_pesan"><?= $Page->tanggal_pesan->caption() ?></span></td>
...
<?php if ($Page->tujuan->Visible) { // tujuan ?>
    <tr id="r_tujuan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tujuan"><?= $Page->tujuan->caption() ?></span></td>
...
<?php if ($Page->disabilitas->Visible) { // disabilitas ?>
    <tr id="r_disabilitas">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_disabilitas"><?= $Page->disabilitas->caption() ?></span></td>
...
<?php if ($Page->nama->Visible) { // nama ?>
    <tr id="r_nama">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_nama"><?= $Page->nama->caption() ?></span></td>
...
<?php if ($Page->no_bpjs->Visible) { // no_bpjs ?>
    <tr id="r_no_bpjs">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_no_bpjs"><?= $Page->no_bpjs->caption() ?></span></td>
...
<?php if ($Page->nomr->Visible) { // nomr ?>
    <tr id="r_nomr">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_nomr"><?= $Page->nomr->caption() ?></span></td>
...
<?php if ($Page->tempat_lahir->Visible) { // tempat_lahir ?>
    <tr id="r_tempat_lahir">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tempat_lahir"><?= $Page->tempat_lahir->caption() ?></span></td>
...
<?php if ($Page->tanggal_lahir->Visible) { // tanggal_lahir ?>
    <tr id="r_tanggal_lahir">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_tanggal_lahir"><?= $Page->tanggal_lahir->caption() ?></span></td>
...
<?php if ($Page->jk->Visible) { // jk ?>
    <tr id="r_jk">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_jk"><?= $Page->jk->caption() ?></span></td>
...
<?php if ($Page->alamat->Visible) { // alamat ?>
    <tr id="r_alamat">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_alamat"><?= $Page->alamat->caption() ?></span></td>
...
<?php if ($Page->agama->Visible) { // agama ?>
    <tr id="r_agama">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_agama"><?= $Page->agama->caption() ?></span></td>
...
<?php if ($Page->pekerjaan->Visible) { // pekerjaan ?>
    <tr id="r_pekerjaan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_pekerjaan"><?= $Page->pekerjaan->caption() ?></span></td>
...
<?php if ($Page->no_telp->Visible) { // no_telp ?>
    <tr id="r_no_telp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_no_telp"><?= $Page->no_telp->caption() ?></span></td>
...
<?php if ($Page->nama_ibu->Visible) { // nama_ibu ?>
    <tr id="r_nama_ibu">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_nama_ibu"><?= $Page->nama_ibu->caption() ?></span></td>
...
<?php if ($Page->nama_ayah->Visible) { // nama_ayah ?>
    <tr id="r_nama_ayah">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_nama_ayah"><?= $Page->nama_ayah->caption() ?></span></td>
...
<?php if ($Page->nama_pasangan->Visible) { // nama_pasangan ?>
    <tr id="r_nama_pasangan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_ANTRIAN_PENDAFTARAN_DISABILITAS_nama_pasangan"><?= $Page->nama_pasangan->caption() ?></span></td>
