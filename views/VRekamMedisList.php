...
loadjs.ready("head", function () {
    ...
    fV_REKAM_MEDISlistsrch.lists.NO_REGISTRATION = <?= $Page->NO_REGISTRATION->toClientList($Page) ?>;
...
<input type="hidden" name="z_NO_REGISTRATION" id="z_NO_REGISTRATION" value="LIKE">
        ...
        <span id="el_V_REKAM_MEDIS_NO_REGISTRATION" class="ew-search-field">
...
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
        <th data-name="EMPLOYEE_ID" class="<?= $Page->EMPLOYEE_ID->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_EMPLOYEE_ID" class="V_REKAM_MEDIS_EMPLOYEE_ID"><?= $Page->renderSort($Page->EMPLOYEE_ID) ?></div></th>
<?php } ?>
<?php if ($Page->TICKET_NO->Visible) { // TICKET_NO ?>
        <th data-name="TICKET_NO" class="<?= $Page->TICKET_NO->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_TICKET_NO" class="V_REKAM_MEDIS_TICKET_NO"><?= $Page->renderSort($Page->TICKET_NO) ?></div></th>
<?php } ?>
...
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
        <th data-name="IDXDAFTAR" class="<?= $Page->IDXDAFTAR->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_IDXDAFTAR" class="V_REKAM_MEDIS_IDXDAFTAR"><?= $Page->renderSort($Page->IDXDAFTAR) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_TICKET_NO">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_IDXDAFTAR">
