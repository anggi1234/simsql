...
var fuserlevelpermissionedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fuserlevelpermissionedit = currentForm = new ew.Form("fuserlevelpermissionedit", "edit");
    ...
    fuserlevelpermissionedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fuserlevelpermissionedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fuserlevelpermissionedit.validate = function () {
    ...
    // Form_CustomValidate
    fuserlevelpermissionedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fuserlevelpermissionedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fuserlevelpermissionedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fuserlevelpermissionedit" id="fuserlevelpermissionedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="userlevelpermission" data-field="x_UserLevelID" data-hidden="1" name="o_UserLevelID" id="o_UserLevelID" value="<?= HtmlEncode($Page->UserLevelID->OldValue ?? $Page->UserLevelID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
