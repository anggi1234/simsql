...
loadjs.ready("head", function () {
    ...
    fGOODS_FORMadd = currentForm = new ew.Form("fGOODS_FORMadd", "add");
    ...
    // Validate form
    fGOODS_FORMadd.validate = function () {
    ...
    // Form_CustomValidate
    fGOODS_FORMadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fGOODS_FORMadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fGOODS_FORMadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fGOODS_FORMadd" id="fGOODS_FORMadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
