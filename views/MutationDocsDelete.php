...
<?php if ($Page->DOC_NO->Visible) { // DOC_NO ?>
        <th class="<?= $Page->DOC_NO->headerCellClass() ?>"><span id="elh_MUTATION_DOCS_DOC_NO" class="MUTATION_DOCS_DOC_NO"><?= $Page->DOC_NO->caption() ?></span></th>
<?php } ?>
...
<?php if ($Page->MUTATION_BY->Visible) { // MUTATION_BY ?>
        <th class="<?= $Page->MUTATION_BY->headerCellClass() ?>"><span id="elh_MUTATION_DOCS_MUTATION_BY" class="MUTATION_DOCS_MUTATION_BY"><?= $Page->MUTATION_BY->caption() ?></span></th>
<?php } ?>
...
<span id="el<?= $Page->RowCount ?>_MUTATION_DOCS_DOC_NO" class="MUTATION_DOCS_DOC_NO">
...
<?php } ?>
<?php if ($Page->MUTATION_BY->Visible) { // MUTATION_BY ?>
        <td <?= $Page->MUTATION_BY->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_MUTATION_DOCS_MUTATION_BY" class="MUTATION_DOCS_MUTATION_BY">
