...
<input type="<?= $Page->TRANS_ID->getInputTextType() ?>" data-table="V_LABORATORIUM" data-field="x_TRANS_ID" data-page="1" name="x_TRANS_ID" id="x_TRANS_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->TRANS_ID->getPlaceHolder()) ?>" value="<?= $Page->TRANS_ID->EditValue ?>"<?= $Page->TRANS_ID->editAttributes() ?> aria-describedby="x_TRANS_ID_help">
