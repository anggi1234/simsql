...
<?php if ($Page->ID->Visible) { // ID ?>
        <th data-name="ID" class="<?= $Page->ID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_V_DAFTAR_PASIEN_ID" class="V_DAFTAR_PASIEN_ID"><?= $Page->renderSort($Page->ID) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_V_DAFTAR_PASIEN_ID">
