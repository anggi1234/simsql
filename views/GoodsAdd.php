...
loadjs.ready("head", function () {
    ...
    fGOODSadd = currentForm = new ew.Form("fGOODSadd", "add");
    ...
    // Form_CustomValidate
    fGOODSadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fGOODSadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fGOODSadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fGOODSadd" id="fGOODSadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fGOODSadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOODSadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fGOODSadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fGOODSadd", "x_AVGDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
