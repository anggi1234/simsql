...
return [
    "Databases" => [
        "DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "SERVERBESEMAH\\SQL2016", "port" => null, "user" => "sa", "password" => "Agussalim7", "dbname" => "RSUD_BESEMAH_VCLAIM_V11"]
    ],
    "SMTP" => [
    ...
    "JWT" => [
        "SECRET_KEY" => "tQ0Jg4vSl5ctSszU", // API Secret Key
