...
class PasienDiagnosaGrid extends PasienDiagnosa
{
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->CurrentMode == "view") { // Check view mode
            ...
            if (IsMobile()) {
                ...
                $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"PASIEN_DIAGNOSA\" data-caption=\"" . $addcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode(GetUrl($this->AddUrl)) . "'});\">" . $Language->phrase("AddLink") . "</a>";
            }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PASIEN_DIAGNOSA_ID
            $this->PASIEN_DIAGNOSA_ID->setDbValueDef($rsnew, $this->PASIEN_DIAGNOSA_ID->CurrentValue, "", $this->PASIEN_DIAGNOSA_ID->ReadOnly);
    ...
    protected function addRow($rsold = null)
    {
        ...
        // PASIEN_DIAGNOSA_ID
        $this->PASIEN_DIAGNOSA_ID->setDbValueDef($rsnew, $this->PASIEN_DIAGNOSA_ID->CurrentValue, "", strval($this->PASIEN_DIAGNOSA_ID->CurrentValue) == "");
