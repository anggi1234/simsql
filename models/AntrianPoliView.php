 ...
 * Page class
 */
class AntrianPoliView extends AntrianPoli
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianPoliView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("VISIT_ID") ?? Route("VISIT_ID")) !== null) {
                ...
                $returnUrl = "AntrianPoliList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AntrianPoliList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AntrianPoliList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
