 ...
 * Page class
 */
class VRawatInapAdd extends VRawatInap
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRawatInapAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "VRawatInapView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['BILL_ID']) == "") {
            $this->setFailureMessage($Language->phrase("InvalidKeyValue"));
            $insertRow = false;
        }
        ...
        if ($detailTblVar != "") {
            ...
            if (in_array("TREATMENT_BILL", $detailTblVar)) {
                ...
                if ($detailPageObj->DetailAdd) {
                    ...
                    $detailPageObj->VISIT_ID->setSessionValue(""); // Clear session key
                    $detailPageObj->IDXDAFTAR->setSessionValue(""); // Clear session key
