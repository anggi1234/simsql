...
class Pasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PASIEN', 'PASIEN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('PASIEN', 'PASIEN', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('PASIEN', 'PASIEN', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // CONTACT_ADDRESS
        $this->CONTACT_ADDRESS = new DbField('PASIEN', 'PASIEN', 'x_CONTACT_ADDRESS', 'CONTACT_ADDRESS', '[CONTACT_ADDRESS]', '[CONTACT_ADDRESS]', 200, 100, -1, false, '[CONTACT_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->FAMILY_STATUS_ID->Lookup = new Lookup('FAMILY_STATUS_ID', 'FAMILY_STATUS', false, 'FAMILY_STATUS_ID', ["FAMILY_STATUS","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->FAMILY_STATUS_ID->Lookup = new Lookup('FAMILY_STATUS_ID', 'FAMILY_STATUS', false, 'FAMILY_STATUS_ID', ["FAMILY_STATUS","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('PASIEN', 'PASIEN', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // AKTIF
        $this->AKTIF = new DbField('PASIEN', 'PASIEN', 'x_AKTIF', 'AKTIF', '[AKTIF]', '[AKTIF]', 129, 1, -1, false, '[AKTIF]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // newapp
        $this->newapp = new DbField('PASIEN', 'PASIEN', 'x_newapp', 'newapp', '[newapp]', '[newapp]', 129, 1, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->TMT->EditValue = FormatDateTime($this->TMT->CurrentValue, 11);
        $this->TMT->PlaceHolder = RemoveHtml($this->TMT->caption());

        // TAT
        $this->TAT->EditAttrs["class"] = "form-control";
        $this->TAT->EditCustomAttributes = "";
        $this->TAT->EditValue = FormatDateTime($this->TAT->CurrentValue, 11);
