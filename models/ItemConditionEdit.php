 ...
 * Page class
 */
class ItemConditionEdit extends ItemCondition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemConditionEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("CONDITION") ?? Key(0) ?? Route(2)) !== null) {
                $this->CONDITION->setQueryStringValue($keyValue);
                $this->CONDITION->setOldValue($this->CONDITION->QueryStringValue);
            } elseif (Post("CONDITION") !== null) {
                $this->CONDITION->setFormValue(Post("CONDITION"));
                $this->CONDITION->setOldValue($this->CONDITION->FormValue);
            } else {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // CONDITION
            $this->CONDITION->setDbValueDef($rsnew, $this->CONDITION->CurrentValue, 0, $this->CONDITION->ReadOnly);
