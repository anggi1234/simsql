...
class PasienVisitationEdit extends PasienVisitation
{
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                ...
                break;
            case "update": // Update
                $returnUrl = 'PasienVisitationView/'.urlencode(CurrentPage()->IDXDAFTAR->CurrentValue).'?showdetail=TREATMENT_BILL,TREATMENT_AKOMODASI';
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // IN_DATE
            $this->IN_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->IN_DATE->CurrentValue, 11), null, $this->IN_DATE->ReadOnly);
