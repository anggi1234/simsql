 ...
 * Page class
 */
class VAkomodasiKamarAdd extends VAkomodasiKamar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VAkomodasiKamarAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "VAkomodasiKamarView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'V_AKOMODASI_KAMAR'
