...
class VRekamMedis extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // BOOKED_DATE
        $this->BOOKED_DATE = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_BOOKED_DATE', 'BOOKED_DATE', '[BOOKED_DATE]', CastDateFieldForLike("[BOOKED_DATE]", 11, "DB"), 135, 8, 11, false, '[BOOKED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISNEW
        $this->ISNEW = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_ISNEW', 'ISNEW', '[ISNEW]', '[ISNEW]', 129, 1, -1, false, '[ISNEW]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->ISNEW->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->ISNEW->Lookup = new Lookup('ISNEW', 'V_REKAM_MEDIS', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ISNEW->Lookup = new Lookup('ISNEW', 'V_REKAM_MEDIS', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 8, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COB
        $this->COB = new DbField('V_REKAM_MEDIS', 'V_REKAM_MEDIS', 'x_COB', 'COB', '[COB]', '[COB]', 129, 1, -1, false, '[COB]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("VRekamMedisEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("VRekamMedisAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
