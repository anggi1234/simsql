 ...
 * Page class
 */
class CustomView1Delete extends CustomView1
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CustomView1Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CustomView1List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CustomView1List"); // Return to list
                return;
            }
        }
