...
class PasienVisitation extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN","GENDER","KODE_AGAMA","CONTACT_ADDRESS"], ["x_DIANTAR_OLEH","x_GENDER","x_KODE_AGAMA","x_VISITOR_ADDRESS"], '[REGISTRATION_DATE] DESC', '');
                break;
            default:
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN","GENDER","KODE_AGAMA","CONTACT_ADDRESS"], ["x_DIANTAR_OLEH","x_GENDER","x_KODE_AGAMA","x_VISITOR_ADDRESS"], '[REGISTRATION_DATE] DESC', '');
                break;
        ...
        $this->DIANTAR_OLEH->IsForeignKey = true; // Foreign key field
        ...
        $this->VISITOR_ADDRESS->IsForeignKey = true; // Foreign key field
        ...
        // RUJUKAN_ID
        $this->RUJUKAN_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RUJUKAN_ID', 'RUJUKAN_ID', '[RUJUKAN_ID]', 'CAST([RUJUKAN_ID] AS NVARCHAR)', 20, 8, -1, false, '[RUJUKAN_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // PATIENT_CATEGORY_ID
        $this->PATIENT_CATEGORY_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_PATIENT_CATEGORY_ID', 'PATIENT_CATEGORY_ID', '[PATIENT_CATEGORY_ID]', 'CAST([PATIENT_CATEGORY_ID] AS NVARCHAR)', 17, 1, -1, false, '[PATIENT_CATEGORY_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // FOLLOW_UP
        $this->FOLLOW_UP = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_FOLLOW_UP', 'FOLLOW_UP', '[FOLLOW_UP]', 'CAST([FOLLOW_UP] AS NVARCHAR)', 17, 1, -1, false, '[FOLLOW_UP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PLACE_TYPE
        $this->PLACE_TYPE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_PLACE_TYPE', 'PLACE_TYPE', '[PLACE_TYPE]', 'CAST([PLACE_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[PLACE_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 8, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // IN_DATE
        $this->IN_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_IN_DATE', 'IN_DATE', '[IN_DATE]', CastDateFieldForLike("[IN_DATE]", 11, "DB"), 135, 8, 11, false, '[IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = false; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSIBLE_ID
        $this->RESPONSIBLE_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RESPONSIBLE_ID', 'RESPONSIBLE_ID', '[RESPONSIBLE_ID]', 'CAST([RESPONSIBLE_ID] AS NVARCHAR)', 17, 1, -1, false, '[RESPONSIBLE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->RESPONSIBLE_ID->Sortable = false; // Allow sort
        $this->RESPONSIBLE_ID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->RESPONSIBLE_ID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->RESPONSIBLE_ID->Lookup = new Lookup('RESPONSIBLE_ID', 'RESPONSIBLES', false, 'RESPONSIBLE_ID', ["RESPONSIBLES","","",""], [], [], [], [], ["RESPONSIBLES"], ["x_RESPONSIBLE"], '', '');
                break;
            default:
                $this->RESPONSIBLE_ID->Lookup = new Lookup('RESPONSIBLE_ID', 'RESPONSIBLES', false, 'RESPONSIBLE_ID', ["RESPONSIBLES","","",""], [], [], [], [], ["RESPONSIBLES"], ["x_RESPONSIBLE"], '', '');
                break;
        ...
        // ISATTENDED
        $this->ISATTENDED = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ISATTENDED', 'ISATTENDED', '[ISATTENDED]', '[ISATTENDED]', 129, 1, -1, false, '[ISATTENDED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ISPERTARIF
        $this->ISPERTARIF = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ISPERTARIF', 'ISPERTARIF', '[ISPERTARIF]', '[ISPERTARIF]', 129, 1, -1, false, '[ISPERTARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID_PLAFOND
        $this->CLASS_ID_PLAFOND = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CLASS_ID_PLAFOND', 'CLASS_ID_PLAFOND', '[CLASS_ID_PLAFOND]', 'CAST([CLASS_ID_PLAFOND] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BACKCHARGE
        $this->BACKCHARGE = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_BACKCHARGE', 'BACKCHARGE', '[BACKCHARGE]', '[BACKCHARGE]', 129, 1, -1, false, '[BACKCHARGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // LOCKED
        $this->LOCKED = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_LOCKED', 'LOCKED', '[LOCKED]', '[LOCKED]', 200, 1, -1, false, '[LOCKED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 10, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tanggal_rujukan
        $this->tanggal_rujukan = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_tanggal_rujukan', 'tanggal_rujukan', '[tanggal_rujukan]', CastDateFieldForLike("[tanggal_rujukan]", 0, "DB"), 135, 8, 0, false, '[tanggal_rujukan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->ISRJ->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->ISRJ->Lookup = new Lookup('ISRJ', 'PASIEN_VISITATION', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ISRJ->Lookup = new Lookup('ISRJ', 'PASIEN_VISITATION', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->ISRJ->OptionCount = 2;
        ...
        // PPKRUJUKAN
        $this->PPKRUJUKAN = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_PPKRUJUKAN', 'PPKRUJUKAN', '[PPKRUJUKAN]', '[PPKRUJUKAN]', 200, 50, -1, false, '[PPKRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // KDPOLI_EKS
        $this->KDPOLI_EKS = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_KDPOLI_EKS', 'KDPOLI_EKS', '[KDPOLI_EKS]', '[KDPOLI_EKS]', 129, 1, -1, false, '[KDPOLI_EKS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COB
        $this->COB = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_COB', 'COB', '[COB]', '[COB]', 129, 1, -1, false, '[COB]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        ...
        // ASALRUJUKAN
        $this->ASALRUJUKAN = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_ASALRUJUKAN', 'ASALRUJUKAN', '[ASALRUJUKAN]', '[ASALRUJUKAN]', 129, 1, -1, false, '[ASALRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONTGLPLG_DESC
        $this->RESPONTGLPLG_DESC = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_RESPONTGLPLG_DESC', 'RESPONTGLPLG_DESC', '[RESPONTGLPLG_DESC]', '[RESPONTGLPLG_DESC]', 200, 250, -1, false, '[RESPONTGLPLG_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CALL_TIMES
        $this->CALL_TIMES = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_CALL_TIMES', 'CALL_TIMES', '[CALL_TIMES]', 'CAST([CALL_TIMES] AS NVARCHAR)', 3, 4, -1, false, '[CALL_TIMES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDXDAFTAR
        $this->IDXDAFTAR = new DbField('PASIEN_VISITATION', 'PASIEN_VISITATION', 'x_IDXDAFTAR', 'IDXDAFTAR', '[IDXDAFTAR]', 'CAST([IDXDAFTAR] AS NVARCHAR)', 3, 4, -1, false, '[IDXDAFTAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "TREATMENT_BILL") {
            ...
            $detailUrl .= "&" . GetForeignKeyUrl("fk_TRANS_ID", $this->TRANS_ID->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_NO_REGISTRATION", $this->NO_REGISTRATION->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_DIANTAR_OLEH", $this->DIANTAR_OLEH->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_VISITOR_ADDRESS", $this->VISITOR_ADDRESS->CurrentValue);
        }
        ...
        if ($detailUrl == "") {
            $detailUrl = "PasienVisitationList";
        }
        return $detailUrl;
    }
    ...
    {
        // Cascade Update detail table 'TREATMENT_BILL'
        $cascadeUpdate = false;
        $rscascade = [];
        ...
        if ($rsold && (isset($rs['TRANS_ID']) && $rsold['TRANS_ID'] != $rs['TRANS_ID'])) { // Update detail field 'TRANS_ID'
            $cascadeUpdate = true;
            $rscascade['TRANS_ID'] = $rs['TRANS_ID'];
        }
        if ($rsold && (isset($rs['NO_REGISTRATION']) && $rsold['NO_REGISTRATION'] != $rs['NO_REGISTRATION'])) { // Update detail field 'NO_REGISTRATION'
            $cascadeUpdate = true;
            $rscascade['NO_REGISTRATION'] = $rs['NO_REGISTRATION'];
        }
        if ($rsold && (isset($rs['DIANTAR_OLEH']) && $rsold['DIANTAR_OLEH'] != $rs['DIANTAR_OLEH'])) { // Update detail field 'THENAME'
            $cascadeUpdate = true;
            $rscascade['THENAME'] = $rs['DIANTAR_OLEH'];
        }
        if ($rsold && (isset($rs['VISITOR_ADDRESS']) && $rsold['VISITOR_ADDRESS'] != $rs['VISITOR_ADDRESS'])) { // Update detail field 'THEADDRESS'
            $cascadeUpdate = true;
            $rscascade['THEADDRESS'] = $rs['VISITOR_ADDRESS'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rsold['VISIT_ID'], DATATYPE_STRING, 'DB') . " AND " . "[TRANS_ID] = " . QuotedValue($rsold['TRANS_ID'], DATATYPE_STRING, 'DB') . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rsold['NO_REGISTRATION'], DATATYPE_STRING, 'DB') . " AND " . "[THENAME] = " . QuotedValue($rsold['DIANTAR_OLEH'], DATATYPE_STRING, 'DB') . " AND " . "[THEADDRESS] = " . QuotedValue($rsold['VISITOR_ADDRESS'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                ...
                $success = Container("TREATMENT_BILL")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("TREATMENT_BILL")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("TREATMENT_BILL")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("TREATMENT_AKOMODASI")->loadRs("[NO_REGISTRATION] = " . QuotedValue($rsold['NO_REGISTRATION'], DATATYPE_STRING, 'DB') . " AND " . "[VISIT_ID] = " . QuotedValue($rsold['VISIT_ID'], DATATYPE_STRING, 'DB') . " AND " . "[THENAME] = " . QuotedValue($rsold['DIANTAR_OLEH'], DATATYPE_STRING, 'DB') . " AND " . "[THEADDRESS] = " . QuotedValue($rsold['VISITOR_ADDRESS'], DATATYPE_STRING, 'DB') . " AND " . "[TRANS_ID] = " . QuotedValue($rsold['TRANS_ID'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'ID';
                $rskey[$fldname] = $rsdtlold[$fldname];
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        // Cascade delete detail table 'TREATMENT_BILL'
        $dtlrows = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rs['VISIT_ID'], DATATYPE_STRING, "DB") . " AND " . "[TRANS_ID] = " . QuotedValue($rs['TRANS_ID'], DATATYPE_STRING, "DB") . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rs['NO_REGISTRATION'], DATATYPE_STRING, "DB") . " AND " . "[THENAME] = " . QuotedValue($rs['DIANTAR_OLEH'], DATATYPE_STRING, "DB") . " AND " . "[THEADDRESS] = " . QuotedValue($rs['VISITOR_ADDRESS'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("TREATMENT_BILL")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("TREATMENT_BILL")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("TREATMENT_BILL")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'TREATMENT_AKOMODASI'
        $dtlrows = Container("TREATMENT_AKOMODASI")->loadRs("[NO_REGISTRATION] = " . QuotedValue($rs['NO_REGISTRATION'], DATATYPE_STRING, "DB") . " AND " . "[VISIT_ID] = " . QuotedValue($rs['VISIT_ID'], DATATYPE_STRING, "DB") . " AND " . "[THENAME] = " . QuotedValue($rs['DIANTAR_OLEH'], DATATYPE_STRING, "DB") . " AND " . "[THEADDRESS] = " . QuotedValue($rs['VISITOR_ADDRESS'], DATATYPE_STRING, "DB") . " AND " . "[TRANS_ID] = " . QuotedValue($rs['TRANS_ID'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("PasienVisitationEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("PasienVisitationAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // tgl_kontrol
        $this->tgl_kontrol->CellCssStyle = "white-space: nowrap;";
    ...
    public function renderEditRow()
    {
        ...
        $this->IN_DATE->EditValue = FormatDateTime($this->IN_DATE->CurrentValue, 11);
        ...
        if (strval($this->ISRJ->CurrentValue) != "") {
            $this->ISRJ->EditValue = $this->ISRJ->optionCaption($this->ISRJ->CurrentValue);
        } else {
        ...
        $this->SEP_PRINTDATE->EditValue = FormatDateTime($this->SEP_PRINTDATE->EditValue, 0);
        $this->SEP_PRINTDATE->ViewCustomAttributes = "";
        ...
        $this->CALL_DATE->EditValue = FormatDateTime($this->CALL_DATE->EditValue, 0);
        $this->CALL_DATE->ViewCustomAttributes = "";
        ...
        $this->CALL_DATES->EditValue = FormatDateTime($this->CALL_DATES->EditValue, 0);
        $this->CALL_DATES->ViewCustomAttributes = "";
        ...
        $this->SERVED_DATE->EditValue = FormatDateTime($this->SERVED_DATE->EditValue, 0);
        $this->SERVED_DATE->ViewCustomAttributes = "";
        ...
        $this->SERVED_INAP->EditValue = FormatDateTime($this->SERVED_INAP->EditValue, 0);
        $this->SERVED_INAP->ViewCustomAttributes = "";
