...
class RegisterRanapSummary extends RegisterRanap
{
    ...
    {
        if ($this->DrillDown) {
            return "dbo.PASIEN_VISITATION.SERVED_INAP DESC, dbo.PASIEN_VISITATION.SERVED_INAP DESC";
        }
        ...
        if ($this->getOrderBy() == "") {
            ...
            if ($useDefaultSort) {
                ...
                $this->setOrderBy("dbo.PASIEN_VISITATION.SERVED_INAP DESC, dbo.PASIEN_VISITATION.SERVED_INAP DESC");
            }
        }
