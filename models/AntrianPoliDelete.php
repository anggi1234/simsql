 ...
 * Page class
 */
class AntrianPoliDelete extends AntrianPoli
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianPoliDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AntrianPoliList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AntrianPoliList"); // Return to list
                return;
            }
        }
