 ...
 * Page class
 */
class ClinicAddopt extends Clinic
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClinicAddopt";
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->CLINIC_ID->IsDetailKey) {
            $this->CLINIC_ID->setFormValue(ConvertFromUtf8($val));
        }
        ...
        if (!$this->NAME_OF_CLINIC->IsDetailKey) {
            $this->NAME_OF_CLINIC->setFormValue(ConvertFromUtf8($val));
        }
        ...
        if (!$this->ORG_ID->IsDetailKey) {
            $this->ORG_ID->setFormValue(ConvertFromUtf8($val));
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->CLINIC_ID->CurrentValue = ConvertToUtf8($this->CLINIC_ID->FormValue);
        $this->NAME_OF_CLINIC->CurrentValue = ConvertToUtf8($this->NAME_OF_CLINIC->FormValue);
        $this->ORG_ID->CurrentValue = ConvertToUtf8($this->ORG_ID->FormValue);
    }
