...
class MutationDocs extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('MUTATION_DOCS', 'MUTATION_DOCS', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        $this->DOC_NO->Sortable = false; // Allow sort
        ...
        $this->ORG_UNIT_FROM->Sortable = false; // Allow sort
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('MUTATION_DOCS', 'MUTATION_DOCS', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        $this->CLINIC_ID->IsForeignKey = true; // Foreign key field
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->CLINIC_ID->Lookup = new Lookup('CLINIC_ID', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["NAME_OF_CLINIC"], ["x_MUTATION_BY"], '', '');
                break;
            default:
                $this->CLINIC_ID->Lookup = new Lookup('CLINIC_ID', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["NAME_OF_CLINIC"], ["x_MUTATION_BY"], '', '');
                break;
        ...
        $this->ORG_ID_TO->Sortable = false; // Allow sort
        ...
        $this->CLINIC_ID_TO->IsForeignKey = true; // Foreign key field
        $this->CLINIC_ID_TO->Sortable = false; // Allow sort
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->CLINIC_ID_TO->Lookup = new Lookup('CLINIC_ID_TO', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["CLINIC_ID","NAME_OF_CLINIC"], ["x_ORG_ID","x_RECEIVED_BY"], '', '');
                break;
            default:
                $this->CLINIC_ID_TO->Lookup = new Lookup('CLINIC_ID_TO', 'CLINIC', false, 'CLINIC_ID', ["NAME_OF_CLINIC","","",""], [], [], [], [], ["CLINIC_ID","NAME_OF_CLINIC"], ["x_ORG_ID","x_RECEIVED_BY"], '', '');
                break;
        ...
        $this->MUTATION_BY->Sortable = false; // Allow sort
        ...
        $this->ORDER_VALUE->Sortable = false; // Allow sort
        ...
        $this->MUTATION_VALUE->Sortable = false; // Allow sort
        ...
        $this->YEAR_ID->Sortable = false; // Allow sort
        ...
        $this->RECEIVED_BY->Sortable = false; // Allow sort
        ...
        $this->FINANCE_ID->Sortable = false; // Allow sort
        ...
        $this->DISTRIBUTION_TYPE->Sortable = false; // Allow sort
        ...
        $this->ACKNOWLEDGEBY->Sortable = false; // Allow sort
        ...
        // COMPANY_ID
        $this->COMPANY_ID = new DbField('MUTATION_DOCS', 'MUTATION_DOCS', 'x_COMPANY_ID', 'COMPANY_ID', '[COMPANY_ID]', '[COMPANY_ID]', 200, 50, -1, false, '[COMPANY_ID]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->COMPANY_ID->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->COMPANY_ID->Lookup = new Lookup('COMPANY_ID', 'MUTATION_DOCS', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->COMPANY_ID->Lookup = new Lookup('COMPANY_ID', 'MUTATION_DOCS', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->COMPANY_ID->OptionCount = 1;
        $this->COMPANY_ID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->COMPANY_ID->Param, "CustomMsg");
        $this->Fields['COMPANY_ID'] = &$this->COMPANY_ID;

        // ID
        $this->ID = new DbField('MUTATION_DOCS', 'MUTATION_DOCS', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 3, 4, -1, false, '[ID]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "GOOD_GF") {
            $detailUrl = Container("GOOD_GF")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->CLINIC_ID_TO->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->CLINIC_ID_TO->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_CLINIC_ID", $this->CLINIC_ID->CurrentValue);
            $detailUrl .= "&" . GetForeignKeyUrl("fk_DOC_NO", $this->DOC_NO->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "MutationDocsList";
        }
        return $detailUrl;
    }
    ...
    public function getEditUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("MutationDocsEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    public function getCopyUrl($parm = "")
    {
        if ($parm != "") {
            ...
            $url = $this->keyUrl("MutationDocsAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->COMPANY_ID->EditValue = $this->COMPANY_ID->options(false);
    ...
    public function rowInserting($rsold, &$rsnew)
    {
        ...
        // Trying to call procedure sql server
        return true;
    }
