...
class VLaboratorium extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // BOOKED_DATE
        $this->BOOKED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BOOKED_DATE', 'BOOKED_DATE', '[BOOKED_DATE]', CastDateFieldForLike("[BOOKED_DATE]", 11, "DB"), 135, 8, 11, false, '[BOOKED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rsold['VISIT_ID'], DATATYPE_STRING, 'DB') . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rsold['NO_REGISTRATION'], DATATYPE_STRING, 'DB') . " AND " . "[TRANS_ID] = " . QuotedValue($rsold['TRANS_ID'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rs['VISIT_ID'], DATATYPE_STRING, "DB") . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rs['NO_REGISTRATION'], DATATYPE_STRING, "DB") . " AND " . "[TRANS_ID] = " . QuotedValue($rs['TRANS_ID'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
