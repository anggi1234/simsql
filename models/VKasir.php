...
class VKasir extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // BOOKED_DATE
        $this->BOOKED_DATE = new DbField('V_KASIR', 'V_KASIR', 'x_BOOKED_DATE', 'BOOKED_DATE', '[BOOKED_DATE]', CastDateFieldForLike("[BOOKED_DATE]", 11, "DB"), 135, 8, 11, false, '[BOOKED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new DbField('V_KASIR', 'V_KASIR', 'x_VISIT_DATE', 'VISIT_DATE', '[VISIT_DATE]', CastDateFieldForLike("[VISIT_DATE]", 11, "DB"), 135, 8, 11, false, '[VISIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_KASIR', 'V_KASIR', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDXDAFTAR
        $this->IDXDAFTAR = new DbField('V_KASIR', 'V_KASIR', 'x_IDXDAFTAR', 'IDXDAFTAR', '[IDXDAFTAR]', 'CAST([IDXDAFTAR] AS NVARCHAR)', 3, 4, -1, false, '[IDXDAFTAR]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rsold['VISIT_ID'], DATATYPE_STRING, 'DB') . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rsold['NO_REGISTRATION'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        $dtlrows = Container("TREATMENT_BILL")->loadRs("[VISIT_ID] = " . QuotedValue($rs['VISIT_ID'], DATATYPE_STRING, "DB") . " AND " . "[NO_REGISTRATION] = " . QuotedValue($rs['NO_REGISTRATION'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
