...
class GoodsEdit extends Goods
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // CODE_5
            $this->CODE_5->setDbValueDef($rsnew, $this->CODE_5->CurrentValue, "", $this->CODE_5->ReadOnly);
            ...
            // OTHER_CODE
            $this->OTHER_CODE->setDbValueDef($rsnew, $this->OTHER_CODE->CurrentValue, null, $this->OTHER_CODE->ReadOnly);
            ...
            // REORDER_POINT
            $this->REORDER_POINT->setDbValueDef($rsnew, $this->REORDER_POINT->CurrentValue, null, $this->REORDER_POINT->ReadOnly);
            ...
            // NET_PRICE
            $this->NET_PRICE->setDbValueDef($rsnew, $this->NET_PRICE->CurrentValue, null, $this->NET_PRICE->ReadOnly);
            ...
            // TH
            $this->TH->setDbValueDef($rsnew, $this->TH->CurrentValue, null, $this->TH->ReadOnly);

            // STATUS_PASIEN_ID
            $this->STATUS_PASIEN_ID->setDbValueDef($rsnew, $this->STATUS_PASIEN_ID->CurrentValue, null, $this->STATUS_PASIEN_ID->ReadOnly);

            // MATERIAL_ID
            $this->MATERIAL_ID->setDbValueDef($rsnew, $this->MATERIAL_ID->CurrentValue, null, $this->MATERIAL_ID->ReadOnly);

            // FORM_ID
            $this->FORM_ID->setDbValueDef($rsnew, $this->FORM_ID->CurrentValue, null, $this->FORM_ID->ReadOnly);

            // ISGENERIC
            $this->ISGENERIC->setDbValueDef($rsnew, $this->ISGENERIC->CurrentValue, null, $this->ISGENERIC->ReadOnly);

            // REGULATE_ID
            $this->REGULATE_ID->setDbValueDef($rsnew, $this->REGULATE_ID->CurrentValue, null, $this->REGULATE_ID->ReadOnly);

            // PREGNANCY_INDEX
            $this->PREGNANCY_INDEX->setDbValueDef($rsnew, $this->PREGNANCY_INDEX->CurrentValue, null, $this->PREGNANCY_INDEX->ReadOnly);

            // INDICATION
            $this->INDICATION->setDbValueDef($rsnew, $this->INDICATION->CurrentValue, null, $this->INDICATION->ReadOnly);

            // TAKE_RULE
            $this->TAKE_RULE->setDbValueDef($rsnew, $this->TAKE_RULE->CurrentValue, null, $this->TAKE_RULE->ReadOnly);

            // SIDE_EFFECT
            $this->SIDE_EFFECT->setDbValueDef($rsnew, $this->SIDE_EFFECT->CurrentValue, null, $this->SIDE_EFFECT->ReadOnly);

            // INTERACTION
            $this->INTERACTION->setDbValueDef($rsnew, $this->INTERACTION->CurrentValue, null, $this->INTERACTION->ReadOnly);

            // CONTRA_INDICATION
            $this->CONTRA_INDICATION->setDbValueDef($rsnew, $this->CONTRA_INDICATION->CurrentValue, null, $this->CONTRA_INDICATION->ReadOnly);

            // WARNING
            $this->WARNING->setDbValueDef($rsnew, $this->WARNING->CurrentValue, null, $this->WARNING->ReadOnly);
            ...
            // ISALKES
            $this->ISALKES->setDbValueDef($rsnew, $this->ISALKES->CurrentValue, null, $this->ISALKES->ReadOnly);

            // SIZE_ORDER
            $this->SIZE_ORDER->setDbValueDef($rsnew, $this->SIZE_ORDER->CurrentValue, null, $this->SIZE_ORDER->ReadOnly);

            // ORDER_PRICE
            $this->ORDER_PRICE->setDbValueDef($rsnew, $this->ORDER_PRICE->CurrentValue, null, $this->ORDER_PRICE->ReadOnly);

            // ISFORMULARIUM
            $this->ISFORMULARIUM->setDbValueDef($rsnew, $this->ISFORMULARIUM->CurrentValue, null, $this->ISFORMULARIUM->ReadOnly);

            // ISESSENTIAL
            $this->ISESSENTIAL->setDbValueDef($rsnew, $this->ISESSENTIAL->CurrentValue, null, $this->ISESSENTIAL->ReadOnly);

            // AVGDATE
            $this->AVGDATE->setDbValueDef($rsnew, UnFormatDateTime($this->AVGDATE->CurrentValue, 0), null, $this->AVGDATE->ReadOnly);

            // STOCK_MINIMAL
            $this->STOCK_MINIMAL->setDbValueDef($rsnew, $this->STOCK_MINIMAL->CurrentValue, null, $this->STOCK_MINIMAL->ReadOnly);

            // STOCK_MINIMAL_APT
            $this->STOCK_MINIMAL_APT->setDbValueDef($rsnew, $this->STOCK_MINIMAL_APT->CurrentValue, null, $this->STOCK_MINIMAL_APT->ReadOnly);

            // HET
            $this->HET->setDbValueDef($rsnew, $this->HET->CurrentValue, null, $this->HET->ReadOnly);

            // default_margin
            $this->default_margin->setDbValueDef($rsnew, $this->default_margin->CurrentValue, null, $this->default_margin->ReadOnly);
