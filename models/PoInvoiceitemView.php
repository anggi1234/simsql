 ...
 * Page class
 */
class PoInvoiceitemView extends PoInvoiceitem
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoInvoiceitemView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "PoInvoiceitemList"; // Return to list
            }
            if (($keyValue = Get("ITEM_ID") ?? Route("ITEM_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PoInvoiceitemList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PoInvoiceitemList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
