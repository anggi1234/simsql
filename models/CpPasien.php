...
/**
 * Table class for cp_pasien
 */
class CpPasien extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'cp_pasien';
        $this->TableName = 'cp_pasien';
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('cp_pasien', 'cp_pasien', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('cp_pasien', 'cp_pasien', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASIEN_ID
        $this->PASIEN_ID = new DbField('cp_pasien', 'cp_pasien', 'x_PASIEN_ID', 'PASIEN_ID', '[PASIEN_ID]', '[PASIEN_ID]', 200, 30, -1, false, '[PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('cp_pasien', 'cp_pasien', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KK_NO
        $this->KK_NO = new DbField('cp_pasien', 'cp_pasien', 'x_KK_NO', 'KK_NO', '[KK_NO]', '[KK_NO]', 200, 30, -1, false, '[KK_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAME_OF_PASIEN
        $this->NAME_OF_PASIEN = new DbField('cp_pasien', 'cp_pasien', 'x_NAME_OF_PASIEN', 'NAME_OF_PASIEN', '[NAME_OF_PASIEN]', '[NAME_OF_PASIEN]', 200, 100, -1, false, '[NAME_OF_PASIEN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PLACE_OF_BIRTH
        $this->PLACE_OF_BIRTH = new DbField('cp_pasien', 'cp_pasien', 'x_PLACE_OF_BIRTH', 'PLACE_OF_BIRTH', '[PLACE_OF_BIRTH]', '[PLACE_OF_BIRTH]', 200, 50, -1, false, '[PLACE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DATE_OF_BIRTH
        $this->DATE_OF_BIRTH = new DbField('cp_pasien', 'cp_pasien', 'x_DATE_OF_BIRTH', 'DATE_OF_BIRTH', '[DATE_OF_BIRTH]', CastDateFieldForLike("[DATE_OF_BIRTH]", 0, "DB"), 135, 8, 0, false, '[DATE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('cp_pasien', 'cp_pasien', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // NATION_ID
        $this->NATION_ID = new DbField('cp_pasien', 'cp_pasien', 'x_NATION_ID', 'NATION_ID', '[NATION_ID]', 'CAST([NATION_ID] AS NVARCHAR)', 17, 1, -1, false, '[NATION_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDUCATION_TYPE_CODE
        $this->EDUCATION_TYPE_CODE = new DbField('cp_pasien', 'cp_pasien', 'x_EDUCATION_TYPE_CODE', 'EDUCATION_TYPE_CODE', '[EDUCATION_TYPE_CODE]', 'CAST([EDUCATION_TYPE_CODE] AS NVARCHAR)', 17, 1, -1, false, '[EDUCATION_TYPE_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARITALSTATUSID
        $this->MARITALSTATUSID = new DbField('cp_pasien', 'cp_pasien', 'x_MARITALSTATUSID', 'MARITALSTATUSID', '[MARITALSTATUSID]', 'CAST([MARITALSTATUSID] AS NVARCHAR)', 17, 1, -1, false, '[MARITALSTATUSID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('cp_pasien', 'cp_pasien', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('cp_pasien', 'cp_pasien', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RT
        $this->RT = new DbField('cp_pasien', 'cp_pasien', 'x_RT', 'RT', '[RT]', '[RT]', 200, 8, -1, false, '[RT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RW
        $this->RW = new DbField('cp_pasien', 'cp_pasien', 'x_RW', 'RW', '[RW]', '[RW]', 200, 20, -1, false, '[RW]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JOB_ID
        $this->JOB_ID = new DbField('cp_pasien', 'cp_pasien', 'x_JOB_ID', 'JOB_ID', '[JOB_ID]', 'CAST([JOB_ID] AS NVARCHAR)', 17, 1, -1, false, '[JOB_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('cp_pasien', 'cp_pasien', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ANAK_KE
        $this->ANAK_KE = new DbField('cp_pasien', 'cp_pasien', 'x_ANAK_KE', 'ANAK_KE', '[ANAK_KE]', 'CAST([ANAK_KE] AS NVARCHAR)', 17, 1, -1, false, '[ANAK_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ANAK_KE->Sortable = true; // Allow sort
        ...
        // CONTACT_ADDRESS
        $this->CONTACT_ADDRESS = new DbField('cp_pasien', 'cp_pasien', 'x_CONTACT_ADDRESS', 'CONTACT_ADDRESS', '[CONTACT_ADDRESS]', '[CONTACT_ADDRESS]', 200, 100, -1, false, '[CONTACT_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PHONE_NUMBER
        $this->PHONE_NUMBER = new DbField('cp_pasien', 'cp_pasien', 'x_PHONE_NUMBER', 'PHONE_NUMBER', '[PHONE_NUMBER]', '[PHONE_NUMBER]', 200, 20, -1, false, '[PHONE_NUMBER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MOBILE
        $this->MOBILE = new DbField('cp_pasien', 'cp_pasien', 'x_MOBILE', 'MOBILE', '[MOBILE]', '[MOBILE]', 200, 20, -1, false, '[MOBILE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MOBILE->Sortable = true; // Allow sort
        $this->MOBILE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MOBILE->Param, "CustomMsg");
        $this->Fields['MOBILE'] = &$this->MOBILE;

        // EMAIL
        $this->_EMAIL = new DbField('cp_pasien', 'cp_pasien', 'x__EMAIL', 'EMAIL', '[EMAIL]', '[EMAIL]', 200, 50, -1, false, '[EMAIL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->_EMAIL->Sortable = true; // Allow sort
        $this->_EMAIL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->_EMAIL->Param, "CustomMsg");
        $this->Fields['EMAIL'] = &$this->_EMAIL;

        // PHOTO_LOCATION
        $this->PHOTO_LOCATION = new DbField('cp_pasien', 'cp_pasien', 'x_PHOTO_LOCATION', 'PHOTO_LOCATION', '[PHOTO_LOCATION]', '[PHOTO_LOCATION]', 200, 50, -1, false, '[PHOTO_LOCATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PHOTO_LOCATION->Sortable = true; // Allow sort
        ...
        // REGISTRATION_DATE
        $this->REGISTRATION_DATE = new DbField('cp_pasien', 'cp_pasien', 'x_REGISTRATION_DATE', 'REGISTRATION_DATE', 'dbo.PASIEN.REGISTRATION_DATE', CastDateFieldForLike("dbo.PASIEN.REGISTRATION_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.PASIEN.REGISTRATION_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('cp_pasien', 'cp_pasien', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('cp_pasien', 'cp_pasien', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('cp_pasien', 'cp_pasien', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POSTAL_CODE
        $this->POSTAL_CODE = new DbField('cp_pasien', 'cp_pasien', 'x_POSTAL_CODE', 'POSTAL_CODE', '[POSTAL_CODE]', '[POSTAL_CODE]', 200, 10, -1, false, '[POSTAL_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GELAR
        $this->GELAR = new DbField('cp_pasien', 'cp_pasien', 'x_GELAR', 'GELAR', '[GELAR]', '[GELAR]', 200, 50, -1, false, '[GELAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BLOOD_TYPE_ID
        $this->BLOOD_TYPE_ID = new DbField('cp_pasien', 'cp_pasien', 'x_BLOOD_TYPE_ID', 'BLOOD_TYPE_ID', '[BLOOD_TYPE_ID]', 'CAST([BLOOD_TYPE_ID] AS NVARCHAR)', 17, 1, -1, false, '[BLOOD_TYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FAMILY_STATUS_ID
        $this->FAMILY_STATUS_ID = new DbField('cp_pasien', 'cp_pasien', 'x_FAMILY_STATUS_ID', 'FAMILY_STATUS_ID', '[FAMILY_STATUS_ID]', 'CAST([FAMILY_STATUS_ID] AS NVARCHAR)', 17, 1, -1, false, '[FAMILY_STATUS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISMENINGGAL
        $this->ISMENINGGAL = new DbField('cp_pasien', 'cp_pasien', 'x_ISMENINGGAL', 'ISMENINGGAL', '[ISMENINGGAL]', '[ISMENINGGAL]', 129, 1, -1, false, '[ISMENINGGAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ISMENINGGAL->Sortable = true; // Allow sort
        ...
        // DEATH_DATE
        $this->DEATH_DATE = new DbField('cp_pasien', 'cp_pasien', 'x_DEATH_DATE', 'DEATH_DATE', '[DEATH_DATE]', CastDateFieldForLike("[DEATH_DATE]", 0, "DB"), 135, 8, 0, false, '[DEATH_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('cp_pasien', 'cp_pasien', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('cp_pasien', 'cp_pasien', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('cp_pasien', 'cp_pasien', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KARYAWAN
        $this->KARYAWAN = new DbField('cp_pasien', 'cp_pasien', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('cp_pasien', 'cp_pasien', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 255, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // NEWCARD
        $this->NEWCARD = new DbField('cp_pasien', 'cp_pasien', 'x_NEWCARD', 'NEWCARD', '[NEWCARD]', CastDateFieldForLike("[NEWCARD]", 0, "DB"), 135, 8, 0, false, '[NEWCARD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NEWCARD->Sortable = true; // Allow sort
        ...
        // BACKCHARGE
        $this->BACKCHARGE = new DbField('cp_pasien', 'cp_pasien', 'x_BACKCHARGE', 'BACKCHARGE', '[BACKCHARGE]', '[BACKCHARGE]', 129, 1, -1, false, '[BACKCHARGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('cp_pasien', 'cp_pasien', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('cp_pasien', 'cp_pasien', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MOTHER
        $this->MOTHER = new DbField('cp_pasien', 'cp_pasien', 'x_MOTHER', 'MOTHER', '[MOTHER]', '[MOTHER]', 200, 150, -1, false, '[MOTHER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MOTHER->Sortable = true; // Allow sort
        $this->MOTHER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MOTHER->Param, "CustomMsg");
        $this->Fields['MOTHER'] = &$this->MOTHER;

        // FATHER
        $this->FATHER = new DbField('cp_pasien', 'cp_pasien', 'x_FATHER', 'FATHER', '[FATHER]', '[FATHER]', 200, 150, -1, false, '[FATHER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->FATHER->Sortable = true; // Allow sort
        $this->FATHER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->FATHER->Param, "CustomMsg");
        $this->Fields['FATHER'] = &$this->FATHER;

        // SPOUSE
        $this->SPOUSE = new DbField('cp_pasien', 'cp_pasien', 'x_SPOUSE', 'SPOUSE', '[SPOUSE]', '[SPOUSE]', 200, 150, -1, false, '[SPOUSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPOUSE->Sortable = true; // Allow sort
        $this->SPOUSE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPOUSE->Param, "CustomMsg");
        $this->Fields['SPOUSE'] = &$this->SPOUSE;

        // AKTIF
        $this->AKTIF = new DbField('cp_pasien', 'cp_pasien', 'x_AKTIF', 'AKTIF', '[AKTIF]', '[AKTIF]', 129, 1, -1, false, '[AKTIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TMT
        $this->TMT = new DbField('cp_pasien', 'cp_pasien', 'x_TMT', 'TMT', '[TMT]', CastDateFieldForLike("[TMT]", 0, "DB"), 135, 8, 0, false, '[TMT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAT
        $this->TAT = new DbField('cp_pasien', 'cp_pasien', 'x_TAT', 'TAT', '[TAT]', CastDateFieldForLike("[TAT]", 0, "DB"), 135, 8, 0, false, '[TAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TAT->Sortable = true; // Allow sort
        $this->TAT->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->TAT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TAT->Param, "CustomMsg");
        $this->Fields['TAT'] = &$this->TAT;

        // CARD_ID
        $this->CARD_ID = new DbField('cp_pasien', 'cp_pasien', 'x_CARD_ID', 'CARD_ID', '[CARD_ID]', '[CARD_ID]', 200, 50, -1, false, '[CARD_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEDICAL_NOTES
        $this->MEDICAL_NOTES = new DbField('cp_pasien', 'cp_pasien', 'x_MEDICAL_NOTES', 'MEDICAL_NOTES', '[MEDICAL_NOTES]', '[MEDICAL_NOTES]', 200, 0, -1, false, '[MEDICAL_NOTES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MEDICAL_NOTES->Sortable = true; // Allow sort
        ...
        // ID
        $this->ID = new DbField('cp_pasien', 'cp_pasien', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 3, 4, -1, false, '[ID]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // newapp
        $this->newapp = new DbField('cp_pasien', 'cp_pasien', 'x_newapp', 'newapp', '[newapp]', '[newapp]', 129, 1, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CpPasienList");
    }
    ...
    {
        global $Language;
        if ($pageName == "CpPasienView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CpPasienEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CpPasienAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CpPasienView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CpPasienView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CpPasienAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CpPasienAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("CpPasienEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CpPasienAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CpPasienDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->TAT->EditValue = FormatDateTime($this->TAT->CurrentValue, 8);
        ...
        if (!$this->MEDICAL_NOTES->Raw) {
            $this->MEDICAL_NOTES->CurrentValue = HtmlDecode($this->MEDICAL_NOTES->CurrentValue);
        }
