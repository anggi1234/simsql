...
class CvPasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('cv_pasien', 'cv_pasien', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DATE_OF_BIRTH
        $this->DATE_OF_BIRTH = new DbField('cv_pasien', 'cv_pasien', 'x_DATE_OF_BIRTH', 'DATE_OF_BIRTH', '[DATE_OF_BIRTH]', CastDateFieldForLike("[DATE_OF_BIRTH]", 0, "DB"), 135, 8, 0, false, '[DATE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('cv_pasien', 'cv_pasien', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDUCATION_TYPE_CODE
        $this->EDUCATION_TYPE_CODE = new DbField('cv_pasien', 'cv_pasien', 'x_EDUCATION_TYPE_CODE', 'EDUCATION_TYPE_CODE', '[EDUCATION_TYPE_CODE]', 'CAST([EDUCATION_TYPE_CODE] AS NVARCHAR)', 17, 1, -1, false, '[EDUCATION_TYPE_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARITALSTATUSID
        $this->MARITALSTATUSID = new DbField('cv_pasien', 'cv_pasien', 'x_MARITALSTATUSID', 'MARITALSTATUSID', '[MARITALSTATUSID]', 'CAST([MARITALSTATUSID] AS NVARCHAR)', 17, 1, -1, false, '[MARITALSTATUSID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('cv_pasien', 'cv_pasien', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('cv_pasien', 'cv_pasien', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JOB_ID
        $this->JOB_ID = new DbField('cv_pasien', 'cv_pasien', 'x_JOB_ID', 'JOB_ID', '[JOB_ID]', 'CAST([JOB_ID] AS NVARCHAR)', 17, 1, -1, false, '[JOB_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('cv_pasien', 'cv_pasien', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTACT_ADDRESS
        $this->CONTACT_ADDRESS = new DbField('cv_pasien', 'cv_pasien', 'x_CONTACT_ADDRESS', 'CONTACT_ADDRESS', '[CONTACT_ADDRESS]', '[CONTACT_ADDRESS]', 200, 100, -1, false, '[CONTACT_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REGISTRATION_DATE
        $this->REGISTRATION_DATE = new DbField('cv_pasien', 'cv_pasien', 'x_REGISTRATION_DATE', 'REGISTRATION_DATE', 'dbo.PASIEN.REGISTRATION_DATE', CastDateFieldForLike("dbo.PASIEN.REGISTRATION_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.PASIEN.REGISTRATION_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('cv_pasien', 'cv_pasien', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BLOOD_TYPE_ID
        $this->BLOOD_TYPE_ID = new DbField('cv_pasien', 'cv_pasien', 'x_BLOOD_TYPE_ID', 'BLOOD_TYPE_ID', '[BLOOD_TYPE_ID]', 'CAST([BLOOD_TYPE_ID] AS NVARCHAR)', 17, 1, -1, false, '[BLOOD_TYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FAMILY_STATUS_ID
        $this->FAMILY_STATUS_ID = new DbField('cv_pasien', 'cv_pasien', 'x_FAMILY_STATUS_ID', 'FAMILY_STATUS_ID', '[FAMILY_STATUS_ID]', 'CAST([FAMILY_STATUS_ID] AS NVARCHAR)', 17, 1, -1, false, '[FAMILY_STATUS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEATH_DATE
        $this->DEATH_DATE = new DbField('cv_pasien', 'cv_pasien', 'x_DEATH_DATE', 'DEATH_DATE', '[DEATH_DATE]', CastDateFieldForLike("[DEATH_DATE]", 0, "DB"), 135, 8, 0, false, '[DEATH_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('cv_pasien', 'cv_pasien', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('cv_pasien', 'cv_pasien', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('cv_pasien', 'cv_pasien', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TMT
        $this->TMT = new DbField('cv_pasien', 'cv_pasien', 'x_TMT', 'TMT', '[TMT]', CastDateFieldForLike("[TMT]", 0, "DB"), 135, 8, 0, false, '[TMT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAT
        $this->TAT = new DbField('cv_pasien', 'cv_pasien', 'x_TAT', 'TAT', '[TAT]', CastDateFieldForLike("[TAT]", 0, "DB"), 135, 8, 0, false, '[TAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEDICAL_NOTES
        $this->MEDICAL_NOTES = new DbField('cv_pasien', 'cv_pasien', 'x_MEDICAL_NOTES', 'MEDICAL_NOTES', '[MEDICAL_NOTES]', '[MEDICAL_NOTES]', 200, 0, -1, false, '[MEDICAL_NOTES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // newapp
        $this->newapp = new DbField('cv_pasien', 'cv_pasien', 'x_newapp', 'newapp', '[newapp]', '[newapp]', 129, 1, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
