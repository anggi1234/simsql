...
class GoodGf extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('GOOD_GF', 'GOOD_GF', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        $this->ORG_ID->IsForeignKey = true; // Foreign key field
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('GOOD_GF', 'GOOD_GF', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","HET",""], [], [], [], [], ["MEASURE_ID","NAME"], ["x_MEASURE_ID","x_BRAND_NAME"], '', '');
                break;
            default:
                $this->BRAND_ID->Lookup = new Lookup('BRAND_ID', 'GOODS', false, 'BRAND_ID', ["NAME","STOCK","HET",""], [], [], [], [], ["MEASURE_ID","NAME"], ["x_MEASURE_ID","x_BRAND_NAME"], '', '');
                break;
        ...
        $this->ROOMS_ID->IsForeignKey = true; // Foreign key field
        ...
        $this->FROM_ROOMS_ID->IsForeignKey = true; // Foreign key field
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('GOOD_GF', 'GOOD_GF', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_DATE
        $this->CORRECTION_DATE = new DbField('GOOD_GF', 'GOOD_GF', 'x_CORRECTION_DATE', 'CORRECTION_DATE', '[CORRECTION_DATE]', CastDateFieldForLike("[CORRECTION_DATE]", 11, "DB"), 135, 8, 11, false, '[CORRECTION_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CORRECTION_DATE->Sortable = true; // Allow sort
        $this->CORRECTION_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        $this->DOC_NO->IsForeignKey = true; // Foreign key field
        ...
        // idx
        $this->idx = new DbField('GOOD_GF', 'GOOD_GF', 'x_idx', 'idx', '[idx]', 'CAST([idx] AS NVARCHAR)', 3, 4, -1, false, '[idx]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    public function getMasterFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            if ($this->ROOMS_ID->getSessionValue() != "") {
                $masterFilter .= "" . GetForeignKeySql("[CLINIC_ID_TO]", $this->ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->ORG_ID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[CLINIC_ID_TO]", $this->ORG_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->FROM_ROOMS_ID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[CLINIC_ID]", $this->FROM_ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->DOC_NO->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("[DOC_NO]", $this->DOC_NO->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS") {
            if ($this->ROOMS_ID->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("[ROOMS_ID]", $this->ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->ORG_ID->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[ORG_ID]", $this->ORG_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->FROM_ROOMS_ID->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[FROM_ROOMS_ID]", $this->FROM_ROOMS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->DOC_NO->getSessionValue() != "") {
                $detailFilter .= " AND " . GetForeignKeySql("[DOC_NO]", $this->DOC_NO->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_MUTATION_DOCS()
    {
        return "[CLINIC_ID_TO]='@CLINIC_ID_TO@' AND [CLINIC_ID_TO]='@CLINIC_ID_TO@' AND [CLINIC_ID]='@CLINIC_ID@' AND [DOC_NO]='@DOC_NO@'";
    }
    // Detail filter
    public function sqlDetailFilter_MUTATION_DOCS()
    {
        return "[ROOMS_ID]='@ROOMS_ID@' AND [ORG_ID]='@ORG_ID@' AND [FROM_ROOMS_ID]='@FROM_ROOMS_ID@' AND [DOC_NO]='@DOC_NO@'";
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "MUTATION_DOCS" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->ROOMS_ID->CurrentValue ?? $this->ROOMS_ID->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->ORG_ID->CurrentValue ?? $this->ORG_ID->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_CLINIC_ID", $this->FROM_ROOMS_ID->CurrentValue ?? $this->FROM_ROOMS_ID->getSessionValue());
            $url .= "&" . GetForeignKeyUrl("fk_DOC_NO", $this->DOC_NO->CurrentValue ?? $this->DOC_NO->getSessionValue());
        }
        return $url;
    }
