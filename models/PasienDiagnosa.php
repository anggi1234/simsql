...
class PasienDiagnosa extends DbTable
{
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN"], ["x_THENAME"], '', '');
                break;
            default:
                $this->NO_REGISTRATION->Lookup = new Lookup('NO_REGISTRATION', 'PASIEN', false, 'NO_REGISTRATION', ["NO_REGISTRATION","","",""], [], [], [], [], ["NAME_OF_PASIEN"], ["x_THENAME"], '', '');
                break;
    ...
    {
        return "dbo.PASIEN_VISITATION.VISIT_ID='@VISIT_ID@' AND dbo.PASIEN_VISITATION.DIANTAR_OLEH='@DIANTAR_OLEH@' AND dbo.PASIEN_VISITATION.NO_REGISTRATION='@NO_REGISTRATION@'";
    }
    // Detail filter
    public function sqlDetailFilter_V_KUNJUNGAN_PASIEN()
    {
        return "[VISIT_ID]='@VISIT_ID@' AND [THENAME]='@THENAME@' AND [NO_REGISTRATION]='@NO_REGISTRATION@'";
    }
