 ...
 * Page class
 */
class PoInvoiceitemAdd extends PoInvoiceitem
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoInvoiceitemAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PoInvoiceitemView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->ORDER_QUANTITY->CurrentValue = null;
        $this->ORDER_QUANTITY->OldValue = $this->ORDER_QUANTITY->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ORDER_DATE
        $this->ORDER_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->ORDER_DATE->CurrentValue, 11), null, false);

        // ATP_DATE
        $this->ATP_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->ATP_DATE->CurrentValue, 11), null, false);

        // DELIVERY_DATE
        $this->DELIVERY_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->DELIVERY_DATE->CurrentValue, 111), null, false);
        ...
        // ORDER_QUANTITY
        $this->ORDER_QUANTITY->setDbValueDef($rsnew, $this->ORDER_QUANTITY->CurrentValue, null, false);
