    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->PASIEN_DIAGNOSA_ID->Raw) {
                $this->PASIEN_DIAGNOSA_ID->AdvancedSearch->SearchValue = HtmlDecode($this->PASIEN_DIAGNOSA_ID->AdvancedSearch->SearchValue);
            }
            $this->PASIEN_DIAGNOSA_ID->EditValue = HtmlEncode($this->PASIEN_DIAGNOSA_ID->AdvancedSearch->SearchValue);
