 ...
 * Page class
 */
class AntrianFarmasiView extends AntrianFarmasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianFarmasiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "AntrianFarmasiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AntrianFarmasiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AntrianFarmasiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
