 ...
 * Page class
 */
class AntrianPendaftaranDisabilitasView extends AntrianPendaftaranDisabilitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianPendaftaranDisabilitasView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "AntrianPendaftaranDisabilitasList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AntrianPendaftaranDisabilitasList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AntrianPendaftaranDisabilitasList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
