...
class MutationDocsView extends MutationDocs
{
    ...
    protected function setupOtherOptions()
    {
        ...
        // "detail_GOOD_GF"
        $item = &$option->add("detail_GOOD_GF");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("GOOD_GF", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("GoodGfList?" . Config("TABLE_SHOW_MASTER") . "=MUTATION_DOCS&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->CLINIC_ID_TO->CurrentValue) . "&" . GetForeignKeyUrl("fk_CLINIC_ID_TO", $this->CLINIC_ID_TO->CurrentValue) . "&" . GetForeignKeyUrl("fk_CLINIC_ID", $this->CLINIC_ID->CurrentValue) . "&" . GetForeignKeyUrl("fk_DOC_NO", $this->DOC_NO->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("GoodGfGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'MUTATION_DOCS')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=GOOD_GF"))) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
            $detailViewTblVar .= "GOOD_GF";
        }
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'MUTATION_DOCS')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=GOOD_GF"))) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        $item->Body = $body;
        $item->Visible = $Security->allowList(CurrentProjectID() . 'GOOD_GF');
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
