 ...
 * Page class
 */
class AntrianPendaftaranDisabilitasDelete extends AntrianPendaftaranDisabilitas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianPendaftaranDisabilitasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AntrianPendaftaranDisabilitasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AntrianPendaftaranDisabilitasList"); // Return to list
                return;
            }
        }
