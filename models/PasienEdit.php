...
class PasienEdit extends Pasien
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // TMT
            $this->TMT->setDbValueDef($rsnew, UnFormatDateTime($this->TMT->CurrentValue, 11), null, $this->TMT->ReadOnly);

            // TAT
            $this->TAT->setDbValueDef($rsnew, UnFormatDateTime($this->TAT->CurrentValue, 11), null, $this->TAT->ReadOnly);
