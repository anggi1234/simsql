...
/**
 * Table class for userlevelpermission
 */
class Userlevelpermission extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'userlevelpermission';
        $this->TableName = 'userlevelpermission';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[userlevelpermission]";
        $this->Dbid = 'DB';
        ...
        // UserLevelID
        $this->UserLevelID = new DbField('userlevelpermission', 'userlevelpermission', 'x_UserLevelID', 'UserLevelID', '[UserLevelID]', 'CAST([UserLevelID] AS NVARCHAR)', 3, 4, -1, false, '[UserLevelID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TableName
        $this->_TableName = new DbField('userlevelpermission', 'userlevelpermission', 'x__TableName', 'TableName', '[TableName]', '[TableName]', 200, 50, -1, false, '[TableName]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // Permission
        $this->_Permission = new DbField('userlevelpermission', 'userlevelpermission', 'x__Permission', 'Permission', '[Permission]', 'CAST([Permission] AS NVARCHAR)', 3, 4, -1, false, '[Permission]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[userlevelpermission]";
    }
