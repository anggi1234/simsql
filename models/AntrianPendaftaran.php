...
class AntrianPendaftaran extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 11, "DB"), 135, 8, 11, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 11, "DB"), 135, 8, 11, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggal_panggil->Sortable = true; // Allow sort
        $this->tanggal_panggil->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_SEPARATOR"], $Language->phrase("IncorrectDateDMY"));
        ...
        // jk
        $this->jk = new DbField('ANTRIAN_PENDAFTARAN', 'ANTRIAN_PENDAFTARAN', 'x_jk', 'jk', '[jk]', 'CAST([jk] AS NVARCHAR)', 3, 4, -1, false, '[jk]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->jk->Sortable = true; // Allow sort
        $this->jk->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->jk->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->jk->Lookup = new Lookup('jk', 'SEX', false, 'GENDER', ["NAME_OF_GENDER","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->jk->Lookup = new Lookup('jk', 'SEX', false, 'GENDER', ["NAME_OF_GENDER","","",""], [], [], [], [], [], [], '', '');
                break;
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        // no_urut
        $this->no_urut->CellCssStyle = "white-space: nowrap;";

        // tanggal_daftar
        $this->tanggal_daftar->CellCssStyle = "white-space: nowrap;";

        // tanggal_panggil
        $this->tanggal_panggil->CellCssStyle = "white-space: nowrap;";

        // loket
        $this->loket->CellCssStyle = "white-space: nowrap;";

        // status_panggil
        $this->status_panggil->CellCssStyle = "white-space: nowrap;";
        ...
        // tanggal_pesan
        $this->tanggal_pesan->CellCssStyle = "white-space: nowrap;";

        // tujuan
        $this->tujuan->CellCssStyle = "white-space: nowrap;";
        ...
        // no_bpjs
        $this->no_bpjs->CellCssStyle = "white-space: nowrap;";

        // nomr
        $this->nomr->CellCssStyle = "white-space: nowrap;";

        // tempat_lahir
        $this->tempat_lahir->CellCssStyle = "white-space: nowrap;";

        // tanggal_lahir
        $this->tanggal_lahir->CellCssStyle = "white-space: nowrap;";
        ...
        // no_telp
        $this->no_telp->CellCssStyle = "white-space: nowrap;";

        // nama_ibu
        $this->nama_ibu->CellCssStyle = "white-space: nowrap;";

        // nama_ayah
        $this->nama_ayah->CellCssStyle = "white-space: nowrap;";

        // nama_pasangan
        $this->nama_pasangan->CellCssStyle = "white-space: nowrap;";
    ...
    public function renderEditRow()
    {
        ...
        $this->tanggal_daftar->EditValue = FormatDateTime($this->tanggal_daftar->CurrentValue, 11);
        ...
        $this->tanggal_panggil->EditValue = FormatDateTime($this->tanggal_panggil->CurrentValue, 11);
