...
class TreatmentAkomodasiAdd extends TreatmentAkomodasi
{
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->TREAT_DATE->IsDetailKey) {
            ...
            $this->TREAT_DATE->CurrentValue = UnFormatDateTime($this->TREAT_DATE->CurrentValue, 111);
        }
        ...
        if (!$this->MODIFIED_DATE->IsDetailKey) {
            ...
            $this->MODIFIED_DATE->CurrentValue = UnFormatDateTime($this->MODIFIED_DATE->CurrentValue, 17);
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->TREAT_DATE->EditValue = HtmlEncode(FormatDateTime($this->TREAT_DATE->CurrentValue, 111));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // TREAT_DATE
        $this->TREAT_DATE->setDbValueDef($rsnew, UnFormatDateTime($this->TREAT_DATE->CurrentValue, 111), null, false);
