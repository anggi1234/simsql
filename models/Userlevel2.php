...
class Userlevel2 extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'userlevel2';
        $this->TableName = 'userlevel';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[userlevel]";
        $this->Dbid = 'DB';
        ...
        // UserLevelID
        $this->UserLevelID = new DbField('userlevel2', 'userlevel', 'x_UserLevelID', 'UserLevelID', '[UserLevelID]', 'CAST([UserLevelID] AS NVARCHAR)', 3, 4, -1, false, '[UserLevelID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserLevelName
        $this->UserLevelName = new DbField('userlevel2', 'userlevel', 'x_UserLevelName', 'UserLevelName', '[UserLevelName]', '[UserLevelName]', 200, 255, -1, false, '[UserLevelName]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[userlevel]";
    }
