 ...
 * Page class
 */
class AntrianFarmasiDelete extends AntrianFarmasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianFarmasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AntrianFarmasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AntrianFarmasiList"); // Return to list
                return;
            }
        }
