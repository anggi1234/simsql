 ...
 * Page class
 */
class VRawatInapDelete extends VRawatInap
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRawatInapDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VRawatInapList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VRawatInapList"); // Return to list
                return;
            }
        }
