...
/**
 * Table class for ANTRIAN_PENDAFTARAN_DISABILITAS
 */
class AntrianPendaftaranDisabilitas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ANTRIAN_PENDAFTARAN_DISABILITAS';
        $this->TableName = 'ANTRIAN_PENDAFTARAN_DISABILITAS';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[ANTRIAN_PENDAFTARAN_DISABILITAS]";
        $this->Dbid = 'DB';
        ...
        // Id
        $this->Id = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 20, 8, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_urut
        $this->no_urut = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_no_urut', 'no_urut', '[no_urut]', 'CAST([no_urut] AS NVARCHAR)', 20, 8, -1, false, '[no_urut]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 0, "DB"), 135, 8, 0, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 0, "DB"), 135, 8, 0, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_loket', 'loket', '[loket]', '[loket]', 200, 10, -1, false, '[loket]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_status_panggil', 'status_panggil', '[status_panggil]', 'CAST([status_panggil] AS NVARCHAR)', 3, 4, -1, false, '[status_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // user
        $this->user = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_user', 'user', '[user]', 'CAST([user] AS NVARCHAR)', 20, 8, -1, false, '[user]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // newapp
        $this->newapp = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_newapp', 'newapp', '[newapp]', 'CAST([newapp] AS NVARCHAR)', 3, 4, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kdpoli
        $this->kdpoli = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_kdpoli', 'kdpoli', '[kdpoli]', '[kdpoli]', 200, 10, -1, false, '[kdpoli]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_pesan
        $this->tanggal_pesan = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tanggal_pesan', 'tanggal_pesan', '[tanggal_pesan]', CastDateFieldForLike("[tanggal_pesan]", 0, "DB"), 135, 8, 0, false, '[tanggal_pesan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tujuan
        $this->tujuan = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tujuan', 'tujuan', '[tujuan]', '[tujuan]', 200, 255, -1, false, '[tujuan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // disabilitas
        $this->disabilitas = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_disabilitas', 'disabilitas', '[disabilitas]', 'CAST([disabilitas] AS NVARCHAR)', 3, 4, -1, false, '[disabilitas]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama
        $this->nama = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_nama', 'nama', '[nama]', '[nama]', 200, 50, -1, false, '[nama]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nama->Sortable = true; // Allow sort
        $this->nama->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->nama->Param, "CustomMsg");
        $this->Fields['nama'] = &$this->nama;

        // no_bpjs
        $this->no_bpjs = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_no_bpjs', 'no_bpjs', '[no_bpjs]', 'CAST([no_bpjs] AS NVARCHAR)', 3, 4, -1, false, '[no_bpjs]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nomr
        $this->nomr = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_nomr', 'nomr', '[nomr]', 'CAST([nomr] AS NVARCHAR)', 3, 4, -1, false, '[nomr]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tempat_lahir
        $this->tempat_lahir = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tempat_lahir', 'tempat_lahir', '[tempat_lahir]', '[tempat_lahir]', 200, 100, -1, false, '[tempat_lahir]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_lahir
        $this->tanggal_lahir = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_tanggal_lahir', 'tanggal_lahir', '[tanggal_lahir]', CastDateFieldForLike("[tanggal_lahir]", 0, "DB"), 133, 8, 0, false, '[tanggal_lahir]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jk
        $this->jk = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_jk', 'jk', '[jk]', 'CAST([jk] AS NVARCHAR)', 3, 4, -1, false, '[jk]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamat
        $this->alamat = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_alamat', 'alamat', '[alamat]', '[alamat]', 200, 150, -1, false, '[alamat]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamat->Sortable = true; // Allow sort
        $this->alamat->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alamat->Param, "CustomMsg");
        $this->Fields['alamat'] = &$this->alamat;

        // agama
        $this->agama = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_agama', 'agama', '[agama]', 'CAST([agama] AS NVARCHAR)', 3, 4, -1, false, '[agama]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pekerjaan
        $this->pekerjaan = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_pekerjaan', 'pekerjaan', '[pekerjaan]', 'CAST([pekerjaan] AS NVARCHAR)', 3, 4, -1, false, '[pekerjaan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_telp
        $this->no_telp = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_no_telp', 'no_telp', '[no_telp]', 'CAST([no_telp] AS NVARCHAR)', 3, 4, -1, false, '[no_telp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_ibu
        $this->nama_ibu = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_nama_ibu', 'nama_ibu', '[nama_ibu]', '[nama_ibu]', 200, 100, -1, false, '[nama_ibu]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_ayah
        $this->nama_ayah = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_nama_ayah', 'nama_ayah', '[nama_ayah]', '[nama_ayah]', 200, 100, -1, false, '[nama_ayah]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nama_pasangan
        $this->nama_pasangan = new DbField('ANTRIAN_PENDAFTARAN_DISABILITAS', 'ANTRIAN_PENDAFTARAN_DISABILITAS', 'x_nama_pasangan', 'nama_pasangan', '[nama_pasangan]', '[nama_pasangan]', 200, 100, -1, false, '[nama_pasangan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[ANTRIAN_PENDAFTARAN_DISABILITAS]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AntrianPendaftaranDisabilitasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AntrianPendaftaranDisabilitasEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AntrianPendaftaranDisabilitasAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AntrianPendaftaranDisabilitasView";
            case Config("API_ADD_ACTION"):
                return "AntrianPendaftaranDisabilitasAdd";
            case Config("API_EDIT_ACTION"):
                return "AntrianPendaftaranDisabilitasEdit";
            case Config("API_DELETE_ACTION"):
                return "AntrianPendaftaranDisabilitasDelete";
            case Config("API_LIST_ACTION"):
                return "AntrianPendaftaranDisabilitasList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AntrianPendaftaranDisabilitasView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AntrianPendaftaranDisabilitasView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AntrianPendaftaranDisabilitasAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AntrianPendaftaranDisabilitasAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AntrianPendaftaranDisabilitasEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AntrianPendaftaranDisabilitasAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AntrianPendaftaranDisabilitasDelete", $this->getUrlParm());
    }
