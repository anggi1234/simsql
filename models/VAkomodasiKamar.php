...
class VAkomodasiKamar extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_VISIT_ID', 'VISIT_ID', 'dbo.TREATMENT_BILL.VISIT_ID', 'dbo.TREATMENT_BILL.VISIT_ID', 200, 50, -1, false, 'dbo.TREATMENT_BILL.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_BILL_ID', 'BILL_ID', 'dbo.TREATMENT_BILL.BILL_ID', 'dbo.TREATMENT_BILL.BILL_ID', 200, 50, -1, false, 'dbo.TREATMENT_BILL.BILL_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.TREATMENT_BILL.NO_REGISTRATION', 'dbo.TREATMENT_BILL.NO_REGISTRATION', 200, 50, -1, false, 'dbo.TREATMENT_BILL.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // THENAME
        $this->THENAME = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_THENAME', 'THENAME', 'dbo.TREATMENT_BILL.THENAME', 'dbo.TREATMENT_BILL.THENAME', 200, 100, -1, false, 'dbo.TREATMENT_BILL.THENAME', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_THEADDRESS', 'THEADDRESS', 'dbo.TREATMENT_BILL.THEADDRESS', 'dbo.TREATMENT_BILL.THEADDRESS', 200, 150, -1, false, 'dbo.TREATMENT_BILL.THEADDRESS', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_THEID', 'THEID', 'dbo.TREATMENT_BILL.THEID', 'dbo.TREATMENT_BILL.THEID', 200, 25, -1, false, 'dbo.TREATMENT_BILL.THEID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_TARIF_ID', 'TARIF_ID', 'dbo.TREATMENT_BILL.TARIF_ID', 'dbo.TREATMENT_BILL.TARIF_ID', 200, 25, -1, false, 'dbo.TREATMENT_BILL.TARIF_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_CLASS_ID', 'CLASS_ID', 'dbo.TREATMENT_BILL.CLASS_ID', 'CAST(dbo.TREATMENT_BILL.CLASS_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_BILL.CLASS_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_CLINIC_ID', 'CLINIC_ID', 'dbo.TREATMENT_BILL.CLINIC_ID', 'dbo.TREATMENT_BILL.CLINIC_ID', 200, 15, -1, false, 'dbo.TREATMENT_BILL.CLINIC_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', 'dbo.TREATMENT_BILL.CLINIC_ID_FROM', 'dbo.TREATMENT_BILL.CLINIC_ID_FROM', 200, 15, -1, false, 'dbo.TREATMENT_BILL.CLINIC_ID_FROM', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_TREATMENT', 'TREATMENT', 'dbo.TREATMENT_BILL.TREATMENT', 'dbo.TREATMENT_BILL.TREATMENT', 200, 200, -1, false, 'dbo.TREATMENT_BILL.TREATMENT', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_TREAT_DATE', 'TREAT_DATE', 'dbo.TREATMENT_BILL.TREAT_DATE', CastDateFieldForLike("dbo.TREATMENT_BILL.TREAT_DATE", 11, "DB"), 135, 8, 11, false, 'dbo.TREATMENT_BILL.TREAT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_TYPE
        $this->CLINIC_TYPE = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_CLINIC_TYPE', 'CLINIC_TYPE', 'dbo.TREATMENT_AKOMODASI.CLINIC_TYPE', 'CAST(dbo.TREATMENT_AKOMODASI.CLINIC_TYPE AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.CLINIC_TYPE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sell_price
        $this->sell_price = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_sell_price', 'sell_price', 'dbo.TREATMENT_BILL.sell_price', 'CAST(dbo.TREATMENT_BILL.sell_price AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.sell_price', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_QUANTITY', 'QUANTITY', 'dbo.TREATMENT_BILL.QUANTITY', 'CAST(dbo.TREATMENT_BILL.QUANTITY AS NVARCHAR)', 131, 8, -1, false, 'dbo.TREATMENT_BILL.QUANTITY', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // amount_paid
        $this->amount_paid = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_amount_paid', 'amount_paid', 'dbo.TREATMENT_BILL.amount_paid', 'CAST(dbo.TREATMENT_BILL.amount_paid AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.amount_paid', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_AMOUNT', 'AMOUNT', 'dbo.TREATMENT_BILL.AMOUNT', 'CAST(dbo.TREATMENT_BILL.AMOUNT AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.AMOUNT', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POKOK_JUAL
        $this->POKOK_JUAL = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_POKOK_JUAL', 'POKOK_JUAL', 'dbo.TREATMENT_BILL.POKOK_JUAL', 'CAST(dbo.TREATMENT_BILL.POKOK_JUAL AS NVARCHAR)', 131, 8, -1, false, 'dbo.TREATMENT_BILL.POKOK_JUAL', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPN
        $this->PPN = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_PPN', 'PPN', 'dbo.TREATMENT_BILL.PPN', 'CAST(dbo.TREATMENT_BILL.PPN AS NVARCHAR)', 131, 8, -1, false, 'dbo.TREATMENT_BILL.PPN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUBSIDI
        $this->SUBSIDI = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_SUBSIDI', 'SUBSIDI', 'dbo.TREATMENT_BILL.SUBSIDI', 'CAST(dbo.TREATMENT_BILL.SUBSIDI AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.SUBSIDI', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KUITANSI_ID
        $this->KUITANSI_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_KUITANSI_ID', 'KUITANSI_ID', 'dbo.TREATMENT_BILL.KUITANSI_ID', 'dbo.TREATMENT_BILL.KUITANSI_ID', 200, 100, -1, false, 'dbo.TREATMENT_BILL.KUITANSI_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_NOTA_NO', 'NOTA_NO', 'dbo.TREATMENT_BILL.NOTA_NO', 'dbo.TREATMENT_BILL.NOTA_NO', 200, 50, -1, false, 'dbo.TREATMENT_BILL.NOTA_NO', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_ISCETAK', 'ISCETAK', 'dbo.TREATMENT_BILL.ISCETAK', 'dbo.TREATMENT_BILL.ISCETAK', 129, 1, -1, false, 'dbo.TREATMENT_BILL.ISCETAK', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_PRINT_DATE', 'PRINT_DATE', 'dbo.TREATMENT_BILL.PRINT_DATE', CastDateFieldForLike("dbo.TREATMENT_BILL.PRINT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_BILL.PRINT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // diskon
        $this->diskon = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_diskon', 'diskon', 'dbo.TREATMENT_BILL.diskon', 'CAST(dbo.TREATMENT_BILL.diskon AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.diskon', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAGIHAN
        $this->TAGIHAN = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_TAGIHAN', 'TAGIHAN', 'dbo.TREATMENT_BILL.TAGIHAN', 'CAST(dbo.TREATMENT_BILL.TAGIHAN AS NVARCHAR)', 6, 8, -1, false, 'dbo.TREATMENT_BILL.TAGIHAN', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_TRANS_ID', 'TRANS_ID', 'dbo.TREATMENT_BILL.TRANS_ID', 'dbo.TREATMENT_BILL.TRANS_ID', 200, 50, -1, false, 'dbo.TREATMENT_BILL.TRANS_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ID
        $this->ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_ID', 'ID', 'dbo.TREATMENT_BILL.ID', 'CAST(dbo.TREATMENT_BILL.ID AS NVARCHAR)', 3, 4, -1, false, 'dbo.TREATMENT_BILL.ID', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_EXIT_DATE', 'EXIT_DATE', 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', CastDateFieldForLike("dbo.TREATMENT_AKOMODASI.EXIT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_BED_ID', 'BED_ID', 'dbo.TREATMENT_AKOMODASI.BED_ID', 'CAST(dbo.TREATMENT_AKOMODASI.BED_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.BED_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_AKOMODASI_KAMAR', 'V_AKOMODASI_KAMAR', 'x_KELUAR_ID', 'KELUAR_ID', 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', 'CAST(dbo.TREATMENT_AKOMODASI.KELUAR_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "V_KUNJUNGAN_PASIEN") {
            ...
            if ($this->NO_REGISTRATION->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("dbo.PASIEN_VISITATION.NO_REGISTRATION", $this->NO_REGISTRATION->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->THENAME->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("dbo.PASIEN_VISITATION.DIANTAR_OLEH", $this->THENAME->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
            if ($this->TRANS_ID->getSessionValue() != "") {
                $masterFilter .= " AND " . GetForeignKeySql("dbo.PASIEN_VISITATION.TRANS_ID", $this->TRANS_ID->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_V_KUNJUNGAN_PASIEN()
    {
        return "dbo.PASIEN_VISITATION.VISIT_ID='@VISIT_ID@' AND dbo.PASIEN_VISITATION.NO_REGISTRATION='@NO_REGISTRATION@' AND dbo.PASIEN_VISITATION.DIANTAR_OLEH='@DIANTAR_OLEH@' AND dbo.PASIEN_VISITATION.TRANS_ID='@TRANS_ID@'";
    }
    // Detail filter
    public function sqlDetailFilter_V_KUNJUNGAN_PASIEN()
    {
        return "dbo.TREATMENT_BILL.VISIT_ID='@VISIT_ID@' AND dbo.TREATMENT_BILL.NO_REGISTRATION='@NO_REGISTRATION@' AND dbo.TREATMENT_BILL.THENAME='@THENAME@' AND dbo.TREATMENT_BILL.TRANS_ID='@TRANS_ID@'";
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.TREATMENT_BILL.ID, dbo.TREATMENT_BILL.BILL_ID, dbo.TREATMENT_BILL.NO_REGISTRATION, dbo.TREATMENT_BILL.VISIT_ID, dbo.TREATMENT_BILL.TARIF_ID, dbo.TREATMENT_BILL.CLASS_ID, dbo.TREATMENT_BILL.CLINIC_ID, dbo.TREATMENT_BILL.CLINIC_ID_FROM, dbo.TREATMENT_BILL.TREATMENT, dbo.TREATMENT_BILL.TREAT_DATE, dbo.TREATMENT_BILL.AMOUNT, dbo.TREATMENT_BILL.QUANTITY, dbo.TREATMENT_BILL.POKOK_JUAL, dbo.TREATMENT_BILL.PPN, dbo.TREATMENT_BILL.SUBSIDI, dbo.TREATMENT_BILL.PRINT_DATE, dbo.TREATMENT_BILL.ISCETAK, dbo.TREATMENT_BILL.NOTA_NO, dbo.TREATMENT_BILL.KUITANSI_ID, dbo.TREATMENT_BILL.THENAME, dbo.TREATMENT_BILL.THEADDRESS, dbo.TREATMENT_BILL.THEID, dbo.TREATMENT_BILL.amount_paid, dbo.TREATMENT_BILL.sell_price, dbo.TREATMENT_BILL.diskon, dbo.TREATMENT_BILL.TAGIHAN, dbo.TREATMENT_BILL.TRANS_ID, dbo.TREATMENT_AKOMODASI.CLINIC_TYPE, dbo.TREATMENT_AKOMODASI.EXIT_DATE, dbo.TREATMENT_AKOMODASI.BED_ID, dbo.TREATMENT_AKOMODASI.KELUAR_ID");
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "V_KUNJUNGAN_PASIEN" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
    ...
    public function exportDocument($doc, $recordset, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->CLINIC_TYPE, '');
                ...
                $doc->exportAggregate($this->EXIT_DATE, '');
                $doc->exportAggregate($this->BED_ID, '');
                $doc->exportAggregate($this->KELUAR_ID, '');
                $doc->endExportRow();
            }
        }
        if (!$doc->ExportCustom) {
