...
class RegisterRanap extends ReportTable
{
    ...
    public function __construct()
    {
        ...
        // TRANS_ID
        $this->TRANS_ID = new ReportField('register_ranap', 'register_ranap', 'x_TRANS_ID', 'TRANS_ID', 'dbo.PASIEN_VISITATION.TRANS_ID', 'dbo.PASIEN_VISITATION.TRANS_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.TRANS_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getSqlSelect() // Select
    {
        ...
        $select = $this->getQueryBuilder()->select("dbo.PASIEN_VISITATION.NO_REGISTRATION, dbo.PASIEN_VISITATION.STATUS_PASIEN_ID, dbo.PASIEN_VISITATION.GENDER, dbo.PASIEN_VISITATION.IDXDAFTAR, dbo.PASIEN_VISITATION.ISRJ, dbo.PASIEN_VISITATION.SERVED_INAP, dbo.PASIEN_VISITATION.VISIT_ID, dbo.TREATMENT_AKOMODASI.TREATMENT, dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID, dbo.TREATMENT_AKOMODASI.DOCTOR, dbo.TREATMENT_AKOMODASI.BED_ID, dbo.PASIEN_VISITATION.DIANTAR_OLEH, dbo.TREATMENT_AKOMODASI.EXIT_DATE, dbo.TREATMENT_AKOMODASI.KELUAR_ID, dbo.TREATMENT_AKOMODASI.AGEYEAR, dbo.PASIEN_VISITATION.TRANS_ID");
        return $select;
    }
