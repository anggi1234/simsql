...
class TreatmentAkomodasiList extends TreatmentAkomodasi
{
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->RESPON, $default, false); // RESPON
        ...
        $this->buildSearchSql($where, $this->NO_SURAT_KET, $default, false); // NO_SURAT_KET
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->RESPON->AdvancedSearch->save(); // RESPON
            ...
            $this->NO_SURAT_KET->AdvancedSearch->save(); // NO_SURAT_KET
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->RESPON->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->NO_SURAT_KET->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->RESPON->AdvancedSearch->unsetSession();
                ...
                $this->NO_SURAT_KET->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->RESPON->AdvancedSearch->load();
                ...
                $this->NO_SURAT_KET->AdvancedSearch->load();
    ...
    protected function loadSearchValues()
    {
        ...
        // RESPON
        if (!$this->isAddOrEdit() && $this->RESPON->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->RESPON->AdvancedSearch->SearchValue != "" || $this->RESPON->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // NO_SURAT_KET
        if (!$this->isAddOrEdit() && $this->NO_SURAT_KET->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->NO_SURAT_KET->AdvancedSearch->SearchValue != "" || $this->NO_SURAT_KET->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->TREAT_DATE->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->TREAT_DATE->AdvancedSearch->SearchValue, 111), 111));
            ...
            if (!$this->NO_SURAT_KET->Raw) {
                $this->NO_SURAT_KET->AdvancedSearch->SearchValue = HtmlDecode($this->NO_SURAT_KET->AdvancedSearch->SearchValue);
            }
            $this->NO_SURAT_KET->EditValue = HtmlEncode($this->NO_SURAT_KET->AdvancedSearch->SearchValue);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fTREATMENT_AKOMODASIlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fTREATMENT_AKOMODASIlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fTREATMENT_AKOMODASIlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_TREATMENT_AKOMODASI" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_TREATMENT_AKOMODASI\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fTREATMENT_AKOMODASIlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
