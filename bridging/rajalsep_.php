...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="25%" rowspan="2"><img src="http://20.10.10.3/simrs/bridging/bpjs.png" width="240" alt="bpjs" /></td>
...
<table width="100%" border="0" cellspacing="2" cellpadding="0">
  ...
  <tr>
    ...
    <td>:</td>
    <td><?php echo date_format(date_create($row["tgl_sep"]),"d/m/Y"); ?></td>
    <td>&nbsp;</td>
    <td></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>:</td>
    <td colspan="2"><span class="style12"><?php if ($row["cob"] == 0){echo "Tidak";}else{echo "Iya";}; ?></span></td>
  </tr>
  <tr>
    <td class="style14"><span class="style13">Jns.Kelamin</span></td>
    <td>:</td>
    <td><span class="style12"><?php if ($row["pasien_jenis_kelamin"] == "l"){echo "Laki-Laki";}else{echo "Perempuan";}; ?></span></td>
