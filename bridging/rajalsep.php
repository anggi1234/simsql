...
$norujukan = $response->response->rujukan->noKunjungan;
...
$update =
"UPDATE `data` 
SET no_sep ='$nosep', kode_diag = '$diagnosa', no_rujuk = '$norujukan', tgl_sep = '$tglsep', faskesrujukan ='$asal', jnspeserta = '$peserta', jnspelayanan = '$pelayanan' WHERE idxdaftar = $id";
...
header("location:https://192.168.1.234/simrs/VPendaftaranList");
?>